/* @(#)36	1.5  src/tcpip/usr/include/isode/ropkt.h, isodelib7, tcpip411, GOLD410 4/5/93 13:27:20 */
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: copyRoSAPdata rosapFsig rosapPsig rosapXsig
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/include/isode/ropkt.h
 */

/* ropkt.h - include file for remote operation providers (RoS-PROVIDER) */

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/include/isode/ropkt.h,v 1.3 93/02/09 08:59:31 snmp Exp $
 *
 ...
 *
 * $Log:	ropkt.h,v $
 * Revision 1.3  93/02/09  08:59:31  snmp
 * Header changes for c++.
 * 
...
#include <isode/acpkt.h>		/* definitions for AcS-PROVIDERs */

#ifndef	_RtSAP_
#include <isode/rtsap.h>		/* definitions for RtS-USERs */
#endif

#ifndef _PSAP2_
#include <isode/psap2.h>		/* definitions for PS-USERs */
#endif

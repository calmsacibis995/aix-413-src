/* @(#)39	1.5  src/tcpip/usr/include/isode/rtpkt.h, isodelib7, tcpip411, GOLD410 4/5/93 13:28:25 */
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: SetPS2RtService SetSS2RtService copyRtSAPdata rtsapFsig rtsapPsig
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/include/isode/rtpkt.h
 */

/* rtpkt.h - include file for reliable transfer providers (RtS-PROVIDER) */

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/include/isode/rtpkt.h,v 1.3 93/02/09 09:00:34 snmp Exp $
 *
 *
 * $Log:	rtpkt.h,v $
 * Revision 1.3  93/02/09  09:00:34  snmp

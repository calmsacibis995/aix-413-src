/* @(#)46	1.5  src/tcpip/usr/include/isode/tpkt.h, isodelib7, tcpip411, GOLD410 4/5/93 13:31:06 */
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: copyTPKTdata copyTSAPdata tsapPsig
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/include/isode/tpkt.h
 */

/* tpkt.h - include file for transport providers (TS-PROVIDER) */

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/include/isode/tpkt.h,v 1.3 93/02/09 09:02:36 snmp Exp $
 *
 *
 * $Log:	tpkt.h,v $
 * Revision 1.3  93/02/09  09:02:36  snmp

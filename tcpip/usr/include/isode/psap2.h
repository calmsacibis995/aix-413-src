/* @(#)34	1.1.1.2  src/tcpip/usr/include/isode/psap2.h, isodelib7, tcpip411, GOLD410 4/5/93 13:26:18 */
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: PAFREE PActDiscRequest PActDiscResponse PActEndRequest 
 *    PActEndResponse PActIntrRequest PActIntrResponse PCFREE PCapdRequest 
 *    PCapdResponse PConnRequest PExpdRequest PFFREE PMajSyncRequest 
 *    PMajSyncResponse PNFREE PPFREE PRFREE PSFREE PTFREE PTypedRequest PVFREE 
 *    PXFREE
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/include/isode/psap2.h
 */

/* psap2.h - include file for presentation users (PS-USER) continued  */

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/include/isode/psap2.h,v 1.2 93/02/05 16:35:58 snmp Exp $
 *
 *
 * $Log:	psap2.h,v $
 * Revision 1.2  93/02/05  16:35:58  snmp
 * ANSI - D67743
 * 
...
#endif
#ifndef	_SSAP_
#include <isode/ssap.h>		/* definitions for SS-USERs */
#endif
#ifndef	_ISOADDRS_
#include <isode/isoaddrs.h>		/* definitions of ISO addresses */
#endif

/* @(#)41	1.5  src/tcpip/usr/include/isode/spkt.h, isodelib7, tcpip411, GOLD410 4/5/93 13:29:53 */
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: copySPKTdata copySSAPdata idmuchP refmuchP ssapAsig ssapFsig 
 *    ssapPsig ssapRsig ssapXsig
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/include/isode/spkt.h
 */

/* spkt.h - include file for session providers (SS-PROVIDER) */

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/include/isode/spkt.h,v 1.3 93/02/09 09:01:08 snmp Exp $
 *
 *
 * $Log:	spkt.h,v $
 * Revision 1.3  93/02/09  09:01:08  snmp
...
#include <isode/tsap.h>		/* definitions for TS-USERs */

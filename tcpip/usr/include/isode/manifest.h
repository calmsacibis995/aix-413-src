/* @(#)28	1.1.1.2  src/tcpip/usr/include/isode/manifest.h, isodelib7, tcpip411, GOLD410 4/5/93 13:18:23 */
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: FD_CLR FD_ISSET FD_SET FD_ZERO QBFREE _signal getdtablesize htonl
 *    htons max min ntohl ntohs siginblock siginmask sigioblock sigiomask 
 *    sigmask
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/include/isode/manifest.h
 */

/* manifest.h - manifest constants */

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/include/isode/manifest.h,v 1.2 93/02/05 16:35:35 snmp Exp $
 *
 *
 * $Log:	manifest.h,v $
 * Revision 1.2  93/02/05  16:35:35  snmp
 * ANSI - D67743
 * 
...
#ifndef	SFD
#if !defined(SVR3) && !defined(SUNOS4) && !defined(BSD44) && !defined(ultrix) && !defined(ps2)
#define	SFD	int
#define	SFP	IFP
#define SFDINT	1	 
#else

/* @(#)40	1.1.1.2  src/tcpip/usr/include/isode/rtsap.h, isodelib7, tcpip411, GOLD410 4/5/93 13:28:49 */
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: RTAFREE RTCFREE RTSFREE RTTFREE RtBeginRequest RtInit 
 *    RtOpenRequest
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/include/isode/rtsap.h
 */

/* rtsap.h - include file for reliable transfer users (RtS-USER) */

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/include/isode/rtsap.h,v 1.2 93/02/05 16:36:28 snmp Exp $
 *
 *
 * $Log:	rtsap.h,v $
 * Revision 1.2  93/02/05  16:36:28  snmp
 * ANSI - D67743
 * 

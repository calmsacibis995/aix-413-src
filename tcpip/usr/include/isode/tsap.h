/* @(#)47	1.1.1.2  src/tcpip/usr/include/isode/tsap.h, isodelib7, tcpip411, GOLD410 4/5/93 13:31:24 */
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: TConnRequest TNetAccept TXFREE
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/include/isode/tsap.h
 */

/* tsap.h - include file for transport users (TS-USER) */

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/include/isode/tsap.h,v 1.2 93/02/05 16:36:58 snmp Exp $
 *
 *
 * $Log:	tsap.h,v $
 * Revision 1.2  93/02/05  16:36:58  snmp
 * ANSI - D67743
 * 

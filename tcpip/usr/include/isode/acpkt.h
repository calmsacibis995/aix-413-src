/* @(#)16	1.5  src/tcpip/usr/include/isode/acpkt.h, isodelib7, tcpip411, GOLD410 4/5/93 13:15:30 */
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: FREEACB acsapFsig acsapPsig copyAcSAPdata missingP toomuchP
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/include/isode/acpkt.h
 */

/* acpkt.h - include file for association control providers (AcS-PROVIDER) */

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/include/isode/acpkt.h,v 1.3 93/02/09 08:55:34 snmp Exp $
 *
 *
 * $Log:	acpkt.h,v $
 * Revision 1.3  93/02/09  08:55:34  snmp
 * Header change for c++
 * 

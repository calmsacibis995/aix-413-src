/* @(#)32	1.5  src/tcpip/usr/include/isode/ppkt.h, isodelib7, tcpip411, GOLD410 4/5/93 13:25:04 */
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: atn_is_ber atn_is_ok copyPSAPdata psapFsig psapPsig pslose pylose
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/include/isode/ppkt.h
 */

/* ppkt.h - include file for presentation providers (PS-PROVIDER) */

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/include/isode/ppkt.h,v 1.3 93/02/09 08:58:47 snmp Exp $
 *
 * RFC1085 (LPP) support contributed by the Wollongong Group, Inc.
 *
 *
 * $Log:	ppkt.h,v $
 * Revision 1.3  93/02/09  08:58:47  snmp
...
#include <isode/ssap.h>		/* definitinos for SS-USERs */

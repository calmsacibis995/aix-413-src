/* @(#)37	1.1.1.2  src/tcpip/usr/include/isode/rosap.h, isodelib7, tcpip411, GOLD410 4/5/93 13:27:41 */
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: ROCFREE ROEFREE ROPFREE RORFREE ROSFREE ROXFREE
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/include/isode/rosap.h
 */

/* rosap.h - include file for remote operation users (RoS-USER) */

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/include/isode/rosap.h,v 1.2 93/02/05 16:36:15 snmp Exp $
 *
 ...
 *
 * $Log:	rosap.h,v $
 * Revision 1.2  93/02/05  16:36:15  snmp
 * ANSI - D67743
 * 

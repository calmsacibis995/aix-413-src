static char sccsid[] = "@(#)12	1.3  src/tcpip/usr/lib/libisode/ts2x25.c, isodelib7, tcpip411, GOLD410 4/5/93 17:17:50";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: XTService _ts2x25_stub read_nsdu_buffer x25init x25open 
 *    x25restore x25retry x25save
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/ts2x25.c
 */

/* ts2x25.c - TPM: X.25 interface */

#ifndef lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/ts2x25.c,v 1.2 93/02/05 17:13:58 snmp Exp $";
#endif

/*
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/ts2x25.c,v 1.2 93/02/05 17:13:58 snmp Exp $
 *
 *
 * $Log:	ts2x25.c,v $
 * Revision 1.2  93/02/05  17:13:58  snmp
 * ANSI - D67743
 * 

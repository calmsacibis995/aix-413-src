static char sccsid[] = "@(#)37	1.3  src/tcpip/usr/lib/libisode/prim2time.c, isodelib7, tcpip411, GOLD410 4/5/93 15:04:55";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: get_usec prim2time str2gent str2utct
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/prim2time.c
 */

/* prim2time.c - presentation element to time string */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/prim2time.c,v 1.2 93/02/05 17:07:00 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/prim2time.c,v 1.2 93/02/05 17:07:00 snmp Exp $
 *
 *
 * $Log:	prim2time.c,v $
 * Revision 1.2  93/02/05  17:07:00  snmp
 * ANSI - D67743
 * 

static char sccsid[] = "@(#)33	1.3  src/tcpip/usr/lib/libisode/prim2qb.c, isodelib7, tcpip411, GOLD410 4/5/93 15:03:24";
/*
 ...
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/prim2qb.c
 */

/* prim2qb.c - presentation element to qbuf */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/prim2qb.c,v 1.2 93/02/05 17:06:50 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/prim2qb.c,v 1.2 93/02/05 17:06:50 snmp Exp $
 *
 *
 * $Log:	prim2qb.c,v $
 * Revision 1.2  93/02/05  17:06:50  snmp
 * ANSI - D67743
 * 

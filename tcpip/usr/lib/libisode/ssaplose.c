static char sccsid[] = "@(#)83	1.3  src/tcpip/usr/lib/libisode/ssaplose.c, isodelib7, tcpip411, GOLD410 4/5/93 16:50:29";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: _ssaplose spktlose ssaplose
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/ssaplose.c
 */

/* ssaplose.c - SPM: you lose */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/ssaplose.c,v 1.2 93/02/05 17:12:06 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/ssaplose.c,v 1.2 93/02/05 17:12:06 snmp Exp $
 *
 *
 * $Log:	ssaplose.c,v $
 * Revision 1.2  93/02/05  17:12:06  snmp
 * ANSI - D67743
 * 
...
va_dcl
{
	...
	if (s -> s_rdata = (char *)malloc ((unsigned) (s -> s_rlen = 1)))

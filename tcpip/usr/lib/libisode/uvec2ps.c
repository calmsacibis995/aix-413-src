static char sccsid[] = "@(#)81	1.3  src/tcpip/usr/lib/libisode/uvec2ps.c, isodelib7, tcpip411, GOLD410 4/5/93 17:24:38";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: ps_get_plen uvec_close uvec_flush uvec_open uvec_setup uvec_write
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/uvec2ps.c
 */

/* uvec2ps.c - uvec-backed abstraction for PStreams */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/uvec2ps.c,v 1.2 93/02/05 17:14:22 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/uvec2ps.c,v 1.2 93/02/05 17:14:22 snmp Exp $
 *
 *
 * $Log:	uvec2ps.c,v $
 * Revision 1.2  93/02/05  17:14:22  snmp
 * ANSI - D67743
 * 
...
int	len;
{
    ...
    if ((ps -> ps_extra = (char *)malloc ((unsigned) len)) == NULL)
	return ps_seterr (ps, PS_ERR_NMEM, NOTOK);

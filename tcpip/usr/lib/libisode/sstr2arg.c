static char sccsid[] = "@(#)27	1.3  src/tcpip/usr/lib/libisode/sstr2arg.c, isodelib7, tcpip411, GOLD410 4/5/93 16:58:25";
/*
 ...
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/sstr2arg.c
 */

/* sstr2arg: convert string into argument list */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/sstr2arg.c,v 1.2 93/02/05 17:12:50 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/sstr2arg.c,v 1.2 93/02/05 17:12:50 snmp Exp $
 *
 *
 * $Log:	sstr2arg.c,v $
 * Revision 1.2  93/02/05  17:12:50  snmp
 * ANSI - D67743
 * 

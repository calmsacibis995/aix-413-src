static char sccsid[] = "@(#)97	1.3  src/tcpip/usr/lib/libisode/dg2ps.c, isodelib7, tcpip411, GOLD410 4/5/93 13:47:20";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: dg_check dg_close dg_flush dg_open dg_prime dg_read dg_setup 
 *    dg_write
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/dg2ps.c
 */

/* dg2ps.c - datagram-backed abstraction for PStreams */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/dg2ps.c,v 1.2 93/02/05 17:04:07 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/dg2ps.c,v 1.2 93/02/05 17:04:07 snmp Exp $
 *
 *
 * $Log:	dg2ps.c,v $
 * Revision 1.2  93/02/05  17:04:07  snmp
 * ANSI - D67743
 * 

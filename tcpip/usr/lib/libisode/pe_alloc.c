static char sccsid[] = "@(#)19	1.3  src/tcpip/usr/lib/libisode/pe_alloc.c, isodelib7, tcpip411, GOLD410 4/5/93 14:13:54";
/*
 ...
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/pe_alloc.c
 */

/* pe_alloc.c - allocate a presentation element */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/pe_alloc.c,v 1.2 93/02/05 17:06:04 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/pe_alloc.c,v 1.2 93/02/05 17:06:04 snmp Exp $
 *
 *
 * $Log:	pe_alloc.c,v $
 * Revision 1.2  93/02/05  17:06:04  snmp
 * ANSI - D67743
 * 

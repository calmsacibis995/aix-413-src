static char sccsid[] = "@(#)76	1.3  src/tcpip/usr/lib/libisode/psapinitiate.c, isodelib7, tcpip411, GOLD410 4/5/93 15:11:15";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: PAsynConnRequest PAsynNextRequest PAsynRetryAux PAsynRetryRequest
 *    PConnRequestAux
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/psapinitiate.c
 */

/* psapinitiate.c - PPM: initiator */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/psapinitiate.c,v 1.2 93/02/05 17:07:35 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/psapinitiate.c,v 1.2 93/02/05 17:07:35 snmp Exp $
 *
 *
 * $Log:	psapinitiate.c,v $
 * Revision 1.2  93/02/05  17:07:35  snmp
 * ANSI - D67743
 * 
...
struct PSAPindication *pi;
{
    ...
    register struct element_PS_1 *cpa_normal = NULL;
    struct type_PS_CPR__type *cpr;
    register struct element_PS_2 *cpr_normal = NULL;

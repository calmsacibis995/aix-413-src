static char sccsid[] = "@(#)94	1.3  src/tcpip/usr/lib/libisode/ssaprovider.c, isodelib7, tcpip411, GOLD410 4/5/93 16:55:34";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: SDataRequest SDataRequestAux SDoCollideAux SReadRequest 
 *    SReadRequestAux SSendRequest SSetIndications SWriteRequest TDATAser 
 *    TDISCser findsblk freesblk newsblk sb2spkt spkt2sd ts2sslose
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/ssaprovider.c
 */

/* ssaprovider.c - implement the session protocol */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/ssaprovider.c,v 1.2 93/02/05 17:12:36 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/ssaprovider.c,v 1.2 93/02/05 17:12:36 snmp Exp $
 *
 *
 * $Log:	ssaprovider.c,v $
 * Revision 1.2  93/02/05  17:12:36  snmp
 * ANSI - D67743
 * 

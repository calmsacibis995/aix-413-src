static char sccsid[] = "@(#)36	1.3  src/tcpip/usr/lib/libisode/tailor.c, isodelib7, tcpip411, GOLD410 4/5/93 17:10:08";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: events_value isodesetailor isodesetvar isodetailor isodexport 
 *    ll_hdfree tailor_read tailor_value tailorfree
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/tailor.c
 */

/* tailor.c - ISODE tailoring */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/tailor.c,v 1.2 93/02/05 17:13:30 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/tailor.c,v 1.2 93/02/05 17:13:30 snmp Exp $
 *
 *
 * $Log:	tailor.c,v $
 * Revision 1.2  93/02/05  17:13:30  snmp
 * ANSI - D67743
 * 
...
register char   *s;
{
    ...
    *bp = NULL;
    ...
    if ((bp = (char *)malloc ((unsigned) (strlen (buffer) + 1))) != NULL)

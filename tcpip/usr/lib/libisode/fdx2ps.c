static char sccsid[] = "@(#)98	1.3  src/tcpip/usr/lib/libisode/fdx2ps.c, isodelib7, tcpip411, GOLD410 4/5/93 13:48:51";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: fdx_check fdx_close fdx_flush fdx_open fdx_prime fdx_read 
 *    fdx_reset fdx_setup fdx_write
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/fdx2ps.c
 */

/* fdx2ps.c - full-duplex abstraction for PStreams */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/fdx2ps.c,v 1.2 93/02/05 17:04:22 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/fdx2ps.c,v 1.2 93/02/05 17:04:22 snmp Exp $
 *
 *
 * $Log:	fdx2ps.c,v $
 * Revision 1.2  93/02/05  17:04:22  snmp
 * ANSI - D67743
 * 
...
int	fd;
{
    ...
    if ((pt -> ps_input.pio_base = (char *)malloc ((unsigned) pz)) == NULL
        || (pt -> ps_output.pio_base = (char *)malloc ((unsigned) pz)) == NULL)
	return ps_seterr (ps, PS_ERR_NMEM, NOTOK);

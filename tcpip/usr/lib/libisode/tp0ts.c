static char sccsid[] = "@(#)07	1.3  src/tcpip/usr/lib/libisode/tp0ts.c, isodelib7, tcpip411, GOLD410 4/5/93 17:13:53";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: TAccept TConnect TDisconnect TDrain TLose TRead TRetry TStart 
 *    TWrite tp0init tp0write
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/tp0ts.c
 */

/* tp0ts.c - TPM: TP0 engine */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/tp0ts.c,v 1.2 93/02/05 17:13:46 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/tp0ts.c,v 1.2 93/02/05 17:13:46 snmp Exp $
 *
 *
 * $Log:	tp0ts.c,v $
 * Revision 1.2  93/02/05  17:13:46  snmp
 * ANSI - D67743
 * 
...
single: ;
    ...
    if (p = (char *)malloc (sizeof *qb + (unsigned) cc)) {
	int	nc,
		onoff;

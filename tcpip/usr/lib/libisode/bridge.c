static char sccsid[] = "@(#)90	1.3  src/tcpip/usr/lib/libisode/bridge.c, isodelib7, tcpip411, GOLD410 4/5/93 13:45:09";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: bridge_read_nsap_addr bridge_write_nsap_addr bridgediscrim 
 *    close_bridge_socket get_bridge_assfd in_connect in_listen 
 *    join_bridge_client join_bridge_server readx start_bridge_client 
 *    start_bridge_server
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/bridge.c
 */

/* bridge.c - X.25 abstractions for TCP bridge to X25 */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/bridge.c,v 1.2 93/02/05 17:03:46 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/bridge.c,v 1.2 93/02/05 17:03:46 snmp Exp $
 *
 * Contributed by Julian Onions, Nottingham University in the UK
 *
 *
 * $Log:	bridge.c,v $
 * Revision 1.2  93/02/05  17:03:46  snmp
 * ANSI - D67743
 * 

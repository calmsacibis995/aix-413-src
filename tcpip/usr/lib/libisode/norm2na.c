static char sccsid[] = "@(#)13	1.3  src/tcpip/usr/lib/libisode/norm2na.c, isodelib7, tcpip411, GOLD410 4/5/93 14:02:21";
/*
 ...
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/norm2na.c
 */

/* norm2na.c - normalize NSAPaddr to NSAP struct */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/norm2na.c,v 1.2 93/02/05 17:05:23 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/norm2na.c,v 1.2 93/02/05 17:05:23 snmp Exp $
 *
 *
 * $Log:	norm2na.c,v $
 * Revision 1.2  93/02/05  17:05:23  snmp
 * ANSI - D67743
 * 

static char sccsid[] = "@(#)82	1.3  src/tcpip/usr/lib/libisode/ssapinitiate.c, isodelib7, tcpip411, GOLD410 4/5/93 16:49:52";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: SAsynConnRequest SAsynNextRequest SAsynRetryAux SAsynRetryRequest
 *    SConnRequestAux dotoken
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/ssapinitiate.c
 */

/* ssapinitiate.c - SPM: initiator */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/ssapinitiate.c,v 1.2 93/02/05 17:12:04 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/ssapinitiate.c,v 1.2 93/02/05 17:12:04 snmp Exp $
 *
 *
 * $Log:	ssapinitiate.c,v $
 * Revision 1.2  93/02/05  17:12:04  snmp
 * ANSI - D67743
 * 

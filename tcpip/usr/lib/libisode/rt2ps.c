static char sccsid[] = "@(#)49	1.3  src/tcpip/usr/lib/libisode/rt2ps.c, isodelib7, tcpip411, GOLD410 4/5/93 15:38:16";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: acs2rtsabort acs2rtslose doPSabort doPSactivity doPSdata 
 *    doPSfinish doPSreport doPSsync doPStoken e ps2rtslose psABORTser 
 *    psACTIVITYser psDATAser psFINISHser psREPORTser psSYNCser psTOKENser 
 *    rt2psasync rt2psgturn rt2pslose rt2psmask rt2pspturn rt2pstrans rt2pswait
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/rt2ps.c
 */

/* rt2ps.c - RTPM: AcSAP/PSAP interface */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/rt2ps.c,v 1.2 93/02/05 17:09:48 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/rt2ps.c,v 1.2 93/02/05 17:09:48 snmp Exp $
 *
 *
 * $Log:	rt2ps.c,v $
 * Revision 1.2  93/02/05  17:09:48  snmp
 * ANSI - D67743
 * 
...
struct RtSAPindication *rti;
{
    ...
    struct type_RTS_RTABapdu	*prtab = NULL;
...
struct RtSAPindication *rti;
{
	...
	congested: ;
	    ...
	    if ((dp = (char *)realloc (acb -> acb_base, i)) == NULL)
		goto congested;
	...
	acb -> acb_len = i;
        ...
        if (pe -> pe_inline) {
            if ((acb -> acb_realbase = acb -> acb_base =
				(char *)malloc ((unsigned int) pe -> pe_len))
		    == NULL)
		goto congested;

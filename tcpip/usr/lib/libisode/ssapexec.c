static char sccsid[] = "@(#)80	1.3  src/tcpip/usr/lib/libisode/ssapexec.c, isodelib7, tcpip411, GOLD410 4/5/93 16:48:41";
/*
 ...
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/ssapexec.c
 */

/* ssapexec.c - SPM: exec */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/ssapexec.c,v 1.2 93/02/05 17:12:00 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/ssapexec.c,v 1.2 93/02/05 17:12:00 snmp Exp $
 *
 *
 * $Log:	ssapexec.c,v $
 * Revision 1.2  93/02/05  17:12:00  snmp
 * ANSI - D67743
 * 

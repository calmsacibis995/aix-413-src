static char sccsid[] = "@(#)96	1.3  src/tcpip/usr/lib/libisode/dgram.c, isodelib7, tcpip411, GOLD410 4/5/93 13:47:37";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: PSEL SSEL action check_dgram_socket close_dgram_socket 
 *    dgram_dummy hack_dgram_socket hexprint inetprint isoprint join_dgram_aux 
 *    read_dgram_socket select_dgram_socket start_clts_server start_udp_server 
 *    write_dgram_socket
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/dgram.c
 */

/* dgram.c - datagram (CL-mode TS) abstractions */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/dgram.c,v 1.2 93/02/05 17:04:09 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/dgram.c,v 1.2 93/02/05 17:04:09 snmp Exp $
 *
 *
 * $Log:	dgram.c,v $
 * Revision 1.2  93/02/05  17:04:09  snmp
 * ANSI - D67743
 * 

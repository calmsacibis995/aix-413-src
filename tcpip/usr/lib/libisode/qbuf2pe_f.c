static char sccsid[] = "@(#)54	1.3  src/tcpip/usr/lib/libisode/qbuf2pe_f.c, isodelib7, tcpip411, GOLD410 4/5/93 15:22:01";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: qb_read_cons qbprintf qbuf2char qbuf2data qbuf2pe_f
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/qbuf2pe_f.c
 */

/* qbuf2pe.c - build PE(s) from an SSDU assumed to be in qbuf(s) */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/qbuf2pe_f.c,v 1.2 93/02/05 17:08:30 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/qbuf2pe_f.c,v 1.2 93/02/05 17:08:30 snmp Exp $
 *
 *
 * $Log:	qbuf2pe_f.c,v $
 * Revision 1.2  93/02/05  17:08:30  snmp
 * ANSI - D67743
 * 

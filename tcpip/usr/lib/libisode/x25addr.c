static char sccsid[] = "@(#)38	1.3  src/tcpip/usr/lib/libisode/x25addr.c, isodelib7, tcpip411, GOLD410 4/5/93 17:25:37";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: _x25addr_stub bcd2char char2bcd elucidate_x25_err gen2if if2gen
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/x25addr.c
 */

/* x25addr.c - X.25 level generic <-> interface address munging */

#ifndef lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/x25addr.c,v 1.2 93/02/05 17:14:25 snmp Exp $";
#endif

/*
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/x25addr.c,v 1.2 93/02/05 17:14:25 snmp Exp $
 *
 * Contributed by George Michaelson, Julian Onions, and John Pavel
 *
 *
 * $Log:	x25addr.c,v $
 * Revision 1.2  93/02/05  17:14:25  snmp
 * ANSI - D67743
 * 

static char sccsid[] = "@(#)15	1.3  src/tcpip/usr/lib/libisode/pe2qb_f.c, isodelib7, tcpip411, GOLD410 4/5/93 14:11:46";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: moveit pe2qb_f
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/pe2qb_f.c
 */

static char sccsid[] = "@(#)01	1.3  src/tcpip/usr/lib/libisode/internet.c, isodelib7, tcpip411, GOLD410 4/5/93 13:50:56";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: close_tcp_socket gethostbyaddr gethostbyname gethostbystring 
 *    getservbyname inet_addr inet_network inet_ntoa join_tcp_client 
 *    join_tcp_server s2a start_tcp_client start_tcp_server
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/internet.c
 */

/* internet.c - TCP/IP abstractions */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/internet.c,v 1.2 93/02/05 17:04:40 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/internet.c,v 1.2 93/02/05 17:04:40 snmp Exp $
 *
 *
 * $Log:	internet.c,v $
 * Revision 1.2  93/02/05  17:04:40  snmp
 * ANSI - D67743
 * 

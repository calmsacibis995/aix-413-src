static char sccsid[] = "@(#)39	1.3  src/tcpip/usr/lib/libisode/ps_alloc.c, isodelib7, tcpip411, GOLD410 4/5/93 15:05:48";
/*
 ...
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/ps_alloc.c
 */

/* ps_alloc.c - allocate a presentation stream */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/ps_alloc.c,v 1.2 93/02/05 17:07:09 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/ps_alloc.c,v 1.2 93/02/05 17:07:09 snmp Exp $
 *
 *
 * $Log:	ps_alloc.c,v $
 * Revision 1.2  93/02/05  17:07:09  snmp
 * ANSI - D67743
 * 

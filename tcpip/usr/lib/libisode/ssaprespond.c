static char sccsid[] = "@(#)91	1.3  src/tcpip/usr/lib/libisode/ssaprespond.c, isodelib7, tcpip411, GOLD410 4/5/93 16:54:14";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: SConnResponse SInit refuse
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/ssaprespond.c
 */

/* ssaprespond.c - SPM: responder */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/ssaprespond.c,v 1.2 93/02/05 17:12:29 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/ssaprespond.c,v 1.2 93/02/05 17:12:29 snmp Exp $
 *
 *
 * $Log:	ssaprespond.c,v $
 * Revision 1.2  93/02/05  17:12:29  snmp
 * ANSI - D67743
 * 
...
struct SSAPindication *si;
{
	...
	if ((s -> s_rdata = (char *)malloc ((unsigned) (s -> s_rlen = 1 + cc)))
		== NULL) {
	    (void) ssaplose (si, SC_CONGEST, NULLCP, "out of memory");
	    goto out2;
	}

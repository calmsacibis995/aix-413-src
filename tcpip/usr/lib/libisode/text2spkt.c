static char sccsid[] = "@(#)01	1.3  src/tcpip/usr/lib/libisode/text2spkt.c, isodelib7, tcpip411, GOLD410 4/5/93 17:11:27";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: SPDU_TYPE spkt2text sprintc text2spkt type_bits type_data 
 *    type_error type_id type_info type_prepare type_reason type_ref 
 *    type_resync type_settings type_ssn type_tsdu type_vrsn
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/text2spkt.c
 */

/* text2spkt.c - read/write a SPDU thru a debug filter */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/text2spkt.c,v 1.2 93/02/05 17:13:37 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/text2spkt.c,v 1.2 93/02/05 17:13:37 snmp Exp $
 *
 *
 * $Log:	text2spkt.c,v $
 * Revision 1.2  93/02/05  17:13:37  snmp
 * ANSI - D67743
 * 

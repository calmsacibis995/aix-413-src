static char sccsid[] = "@(#)02	1.3  src/tcpip/usr/lib/libisode/isoaddrs.c, isodelib7, tcpip411, GOLD410 4/5/93 13:52:34";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: IMPLODE MHASH SEL2STR _paddr2str add_macro free_macros macro2comm
 *    macro2str name2macro p_ia5_dsp_len read_file read_macros str2paddr 
 *    value2macro
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/isoaddrs.c
 */

/* isoaddrs.c - simple parsing of ISODE addresses */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/isoaddrs.c,v 1.2 93/02/05 17:04:48 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/isoaddrs.c,v 1.2 93/02/05 17:04:48 snmp Exp $
 *
 *
 * $Log:	isoaddrs.c,v $
 * Revision 1.2  93/02/05  17:04:48  snmp
 * ANSI - D67743
 * 
       ...
       *value;
{
	...
	*cp++ = NULL;
    ...
    if ((m -> m_name = (char *) malloc ((unsigned) (strlen (name) + 1))) == NULL
		|| (m -> m_value = (char *)malloc ((unsigned) (strlen (value) + 1)))
	    == NULL) {
	SLOG (addr_log, LLOG_EXCEPTIONS, NULLCP,

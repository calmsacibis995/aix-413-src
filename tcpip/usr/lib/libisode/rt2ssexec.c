static char sccsid[] = "@(#)56	1.3  src/tcpip/usr/lib/libisode/rt2ssexec.c, isodelib7, tcpip411, GOLD410 4/5/93 16:08:24";
/*
 ...
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/rt2ssexec.c
 */

/* rt2ssexec.c - RTPM: exec */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/rt2ssexec.c,v 1.2 93/02/05 17:10:04 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/rt2ssexec.c,v 1.2 93/02/05 17:10:04 snmp Exp $
 *
 *
 * $Log:	rt2ssexec.c,v $
 * Revision 1.2  93/02/05  17:10:04  snmp
 * ANSI - D67743
 * 

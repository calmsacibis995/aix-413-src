static char sccsid[] = "@(#)55	1.3  src/tcpip/usr/lib/libisode/rt2ss.c, isodelib7, tcpip411, GOLD410 4/5/93 16:07:15";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: doSSactivity doSSdata doSSfinish doSSreport doSSsync doSStoken 
 *    rt2ssasync rt2ssgturn rt2sslose rt2ssmask rt2sspturn rt2sstrans rt2sswait
 *    ss2rtsabort ss2rtslose ssABORTser ssACTIVITYser ssDATAser ssFINISHser 
 *    ssREPORTser ssSYNCser ssTOKENser
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/rt2ss.c
 */

/* rt2ss.c - RTPM: SSAP interface */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/rt2ss.c,v 1.2 93/02/05 17:10:01 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/rt2ss.c,v 1.2 93/02/05 17:10:01 snmp Exp $
 *
 *
 * $Log:	rt2ss.c,v $
 * Revision 1.2  93/02/05  17:10:01  snmp
 * ANSI - D67743
 * 

static char sccsid[] = "@(#)75	1.3  src/tcpip/usr/lib/libisode/psapexec.c, isodelib7, tcpip411, GOLD410 4/5/93 15:10:36";
/*
 ...
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/psapexec.c
 */

/* psapexec.c - PPM: exec */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/psapexec.c,v 1.2 93/02/05 17:07:32 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/psapexec.c,v 1.2 93/02/05 17:07:32 snmp Exp $
 *
 *
 * $Log:	psapexec.c,v $
 * Revision 1.2  93/02/05  17:07:32  snmp
 * ANSI - D67743
 * 

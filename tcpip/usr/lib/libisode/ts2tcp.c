static char sccsid[] = "@(#)11	1.3  src/tcpip/usr/lib/libisode/ts2tcp.c, isodelib7, tcpip411, GOLD410 4/5/93 17:17:19";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: TTService tcpinit tcpopen tcprestore tcpretry tcpsave
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/ts2tcp.c
 */

/* ts2tcp.c - TPM: TCP interface */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/ts2tcp.c,v 1.2 93/02/05 17:13:56 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/ts2tcp.c,v 1.2 93/02/05 17:13:56 snmp Exp $
 *
 *
 * $Log:	ts2tcp.c,v $
 * Revision 1.2  93/02/05  17:13:56  snmp
 * ANSI - D67743
 * 

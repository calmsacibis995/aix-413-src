static char sccsid[] = "@(#)53	1.2  src/tcpip/usr/lib/libisode/util.c, isodelib7, tcpip411, GOLD410 3/2/93 17:35:17";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: MIN NENTRY bitscmp dmp_tpe f_null fdflt_b fdflt_f ferr ferrd 
 *    hasdata ismatch next_tpe ostrcmp p_pr_entry pepsylose ppepsylose pr_entry
 *    pr_petype same
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/util.c
 */

/* util.c */
#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/util.c,v 1.2 93/02/05 17:14:21 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/util.c,v 1.2 93/02/05 17:14:21 snmp Exp $
 *
 *
 * $Log:	util.c,v $
 * Revision 1.2  93/02/05  17:14:21  snmp
 * ANSI - D67743
 * 
...
va_dcl
{
	...
	if ((signed int)(pe && pe -> pe_class) >= 0 && 
	    pe -> pe_class < pe_maxclass) {
	    cp = PY_pepy + strlen (PY_pepy);

static char sccsid[] = "@(#)14	1.3  src/tcpip/usr/lib/libisode/tsapinitiate.c, isodelib7, tcpip411, GOLD410 4/5/93 17:18:45";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: TAsynConnRequest TAsynNextRequest TAsynRetryRequest TConnAttempt 
 *    TConnRequestAux maketsbaddr newtaddr ta2norm
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/tsapinitiate.c
 */

/* tsapinitiate.c - TPM: initiator */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/tsapinitiate.c,v 1.2 93/02/05 17:14:01 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/tsapinitiate.c,v 1.2 93/02/05 17:14:01 snmp Exp $
 *
 *
 * $Log:	tsapinitiate.c,v $
 * Revision 1.2  93/02/05  17:14:01  snmp
 * ANSI - D67743
 * 
...
register struct TSAPdisconnect *td;
{
    ...
    *tb -> tb_called = *called;		/* struct copy */
    ...
    if ((tb -> tb_cc = cc) > 0) {
	if ((tb -> tb_data = (char *)malloc ((unsigned) cc)) == NULLCP) {
no_mem: ;

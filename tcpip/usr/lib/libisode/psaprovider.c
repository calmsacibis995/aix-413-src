static char sccsid[] = "@(#)88	1.3  src/tcpip/usr/lib/libisode/psaprovider.c, isodelib7, tcpip411, GOLD410 4/5/93 15:17:03";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: ABORTser ACTIVITYser DATAser FINISHser PDataRequest 
 *    PDataRequestAux PReadRequest PReadRequestAux PSetIndications REPORTser 
 *    SYNCser TOKENser doACTIVITY doDATA doFINISH doREPORT doSYNC doTOKEN e 
 *    findpblk freepblk info2ppdu info2qb info2ssdu newpblk ppdu2info qb2info 
 *    qbuf2info silly_list ss2psabort ss2pslose ssdu2info
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/psaprovider.c
 */

/* psaprovider.c - implement the presentation protocol */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/psaprovider.c,v 1.2 93/02/05 17:08:00 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/psaprovider.c,v 1.2 93/02/05 17:08:00 snmp Exp $
 *
 *
 * $Log:	psaprovider.c,v $
 * Revision 1.2  93/02/05  17:08:00  snmp
 * ANSI - D67743
 * 
	...
	ppdu;
{
    ...
    register struct type_PS_Simply__encoded__data *simple = NULL;
    register struct type_PS_Fully__encoded__data **complex = NULL,
						  *full;

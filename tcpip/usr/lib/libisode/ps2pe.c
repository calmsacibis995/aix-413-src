static char sccsid[] = "@(#)38	1.3  src/tcpip/usr/lib/libisode/ps2pe.c, isodelib7, tcpip411, GOLD410 4/5/93 15:05:21";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: ps2pe_aux ps_read_cons ps_read_id ps_read_len
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/ps2pe.c
 */

/* ps2pe.c - presentation stream to presentation element */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/ps2pe.c,v 1.2 93/02/05 17:07:07 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/ps2pe.c,v 1.2 93/02/05 17:07:07 snmp Exp $
 *
 *
 * $Log:	ps2pe.c,v $
 * Revision 1.2  93/02/05  17:07:07  snmp
 * ANSI - D67743
 * 

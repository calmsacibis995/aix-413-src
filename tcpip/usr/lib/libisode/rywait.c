static char sccsid[] = "@(#)42	1.3  src/tcpip/usr/lib/libisode/rywait.c, isodelib7, tcpip411, GOLD410 4/5/93 16:31:59";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: RyWait RyWaitAux
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/rywait.c
 */

/* rywait.c - ROSY: wait */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/rywait.c,v 1.2 93/02/05 17:11:05 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/rywait.c,v 1.2 93/02/05 17:11:05 snmp Exp $
 *
 *
 * $Log:	rywait.c,v $
 * Revision 1.2  93/02/05  17:11:05  snmp
 * ANSI - D67743
 * 
...
struct RoSAPindication *roi;
{
    ...
    register struct RyOperation *ryo = NULL;

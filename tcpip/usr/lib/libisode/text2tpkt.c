static char sccsid[] = "@(#)06	1.3  src/tcpip/usr/lib/libisode/text2tpkt.c, isodelib7, tcpip411, GOLD410 4/5/93 17:12:00";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: TPKT_TYPE text2tpkt tpkt2text type_data type_id
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/text2tpkt.c
 */

/* text2tpkt.c - test utilities for use with TPDU packets */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/text2tpkt.c,v 1.2 93/02/05 17:13:39 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/text2tpkt.c,v 1.2 93/02/05 17:13:39 snmp Exp $
 *
 *
 * $Log:	text2tpkt.c,v $
 * Revision 1.2  93/02/05  17:13:39  snmp
 * ANSI - D67743
 * 

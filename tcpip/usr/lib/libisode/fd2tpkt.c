static char sccsid[] = "@(#)04	1.3  src/tcpip/usr/lib/libisode/fd2tpkt.c, isodelib7, tcpip411, GOLD410 4/5/93 13:48:33";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: fd2tpkt fd2tpktaux freetpkt newtpkt readx tpkt2fd
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/fd2tpkt.c
 */

/* fd2tpkt.c - read/write a TPDU thru a socket */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/fd2tpkt.c,v 1.2 93/02/05 17:04:20 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/fd2tpkt.c,v 1.2 93/02/05 17:04:20 snmp Exp $
 *
 *
 * $Log:	fd2tpkt.c,v $
 * Revision 1.2  93/02/05  17:04:20  snmp
 * ANSI - D67743
 * 
	...
	readfnx;
{
	...
	case TPDU_CC:
		...
		if ((vptr = t -> t_vdata = (char *)malloc ((unsigned) vlen)) == NULL)
		    return DR_CONGEST;
...
IFP	writefnx;
{
	...
	case TPDU_CC:
	    if ((vptr = t -> t_vdata =
		    (char *)malloc ((unsigned) (3 + 7 + (2 + t -> t_callinglen)

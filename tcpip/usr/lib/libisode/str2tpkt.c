static char sccsid[] = "@(#)05	1.3  src/tcpip/usr/lib/libisode/str2tpkt.c, isodelib7, tcpip411, GOLD410 4/5/93 17:05:39";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: getfnx putfnx readfnx str2tpkt tpkt2str writefnx
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/str2tpkt.c
 */

/* str2tpkt.c - read/write a TPDU thru a string */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/str2tpkt.c,v 1.2 93/02/05 17:13:15 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/str2tpkt.c,v 1.2 93/02/05 17:13:15 snmp Exp $
 *
 *
 * $Log:	str2tpkt.c,v $
 * Revision 1.2  93/02/05  17:13:15  snmp
 * ANSI - D67743
 * 

static char sccsid[] = "@(#)46	1.2  src/tcpip/usr/lib/libisode/dec.c, isodelib7, tcpip411, GOLD410 3/2/93 16:08:16";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: ALLOC_MEM CHKTAG NEXT_TPE dec_f fix_mem inpm oom pr_choice 
 *    pr_etype pr_obj pr_seq pr_seqof pr_set pr_setof pr_type setdval 
 *    setpresent
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/dec.c
 */

/* dec.c */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/dec.c,v 1.2 93/02/05 17:04:03 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/dec.c,v 1.2 93/02/05 17:04:03 snmp Exp $
 *
 *
 * $Log:	dec.c,v $
 * Revision 1.2  93/02/05  17:04:03  snmp
 * ANSI - D67743
 * 

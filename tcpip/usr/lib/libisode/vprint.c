static char sccsid[] = "@(#)85	1.4  src/tcpip/usr/lib/libisode/vprint.c, isodelib7, tcpip411, GOLD410 4/5/93 17:25:03";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: _vpdu bit2str free_bp newbuf oct2str pvpdu vname vpop vpopfp 
 *    vpopp vpopquipu vpopstr vprint vprint1 vprint2 vpush vpushfp vpushpp 
 *    vpushquipu vpushstr vsetfp vstring vtag vunknown vwrite
 *
 * ORIGINS: 60
 * 
 * FILE:	src/tcpip/usr/lib/libisode/vprint.c
 */

/* vprint.c - pepy printer support */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/vprint.c,v 1.2 93/02/05 17:14:24 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/vprint.c,v 1.2 93/02/05 17:14:24 snmp Exp $
 *
 *
 * $Log:	vprint.c,v $
 * Revision 1.2  93/02/05  17:14:24  snmp
 * ANSI - D67743
 * 
...
int	i;
{
    ...
    if (bp)
	free (bp);
    if ((bp = (char *)malloc ((unsigned int) i)))
	len = i;
    else
	len = 0;

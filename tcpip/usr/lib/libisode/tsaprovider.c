static char sccsid[] = "@(#)20	1.3  src/tcpip/usr/lib/libisode/tsaprovider.c, isodelib7, tcpip411, GOLD410 4/5/93 17:21:55";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: DATAser TDataRequest TDiscRequest TExpdRequest TReadRequest 
 *    TSelectMask TSetIndications TWakeUp TWriteRequest copyTSAPaddrX 
 *    copyTSAPaddrY findtblk freetblk newtblk selmask
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/tsaprovider.c
 */

/* tsaprovider.c - implement the transport service */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/tsaprovider.c,v 1.2 93/02/05 17:14:11 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/tsaprovider.c,v 1.2 93/02/05 17:14:11 snmp Exp $
 *
 *
 * $Log:	tsaprovider.c,v $
 * Revision 1.2  93/02/05  17:14:11  snmp
 * ANSI - D67743
 * 
...
struct TSAPdisconnect *td;
{
	...
	(void) signal (SIGEMT, (void (*)(int))DATAser);
#else /* !_ANSI_C_SOURCE */
	(void) signal (SIGEMT, DATAser);

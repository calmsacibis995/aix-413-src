static char sccsid[] = "@(#)10	1.3  src/tcpip/usr/lib/libisode/ts2sunlink.c, isodelib7, tcpip411, GOLD410 4/5/93 17:16:40";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: ReadDisc _ts2sunlink_stub newtp4pkt
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/ts2sunlink.c
 */

/* ts2sunlink.c - TPM: SunLink OSI TP4 interface */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/ts2sunlink.c,v 1.2 93/02/05 17:13:54 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/ts2sunlink.c,v 1.2 93/02/05 17:13:54 snmp Exp $
 *
 * Contributed by John A. Scott, The MITRE Corporation
 *
 *
 * $Log:	ts2sunlink.c,v $
 * Revision 1.2  93/02/05  17:13:54  snmp
 * ANSI - D67743
 * 

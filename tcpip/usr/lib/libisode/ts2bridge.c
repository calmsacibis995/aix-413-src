static char sccsid[] = "@(#)08	1.3  src/tcpip/usr/lib/libisode/ts2bridge.c, isodelib7, tcpip411, GOLD410 4/5/93 17:14:38";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: BTService _ts2bridge_stub bridgeopen bridgerestore bridgeretry 
 *    bridgesave
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/ts2bridge.c
 */

/* ts2bridge.c - TPM: X.25 interface via bridge */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/ts2bridge.c,v 1.2 93/02/05 17:13:48 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/ts2bridge.c,v 1.2 93/02/05 17:13:48 snmp Exp $
 *
 * Contributed by Julian Onions, Nottingham University in the UK
 *
 *
 * $Log:	ts2bridge.c,v $
 * Revision 1.2  93/02/05  17:13:48  snmp
 * ANSI - D67743
 * 

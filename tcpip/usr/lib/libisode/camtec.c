static char sccsid[] = "@(#)91	1.3  src/tcpip/usr/lib/libisode/camtec.c, isodelib7, tcpip411, GOLD410 4/5/93 13:45:30";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: _sunlink_stub _sunlink_stub2 join_x25_client join_x25_server 
 *    read_x25_socket start_x25_client start_x25_server write_x25_socket
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/camtec.c
 */

/* camtec.c - X.25, CONS abstractions for CAMTEC CCL  */

#ifndef lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/camtec.c,v 1.2 93/02/05 17:03:48 snmp Exp $";
#endif

/*
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/camtec.c,v 1.2 93/02/05 17:03:48 snmp Exp $
 *
 * Contributed by Keith Ruttle, CAMTEC Electronics Ltd
 *
 *
 * $Log:	camtec.c,v $
 * Revision 1.2  93/02/05  17:03:48  snmp
 * ANSI - D67743
 * 
...
#else 	/* CAMTEC_CCL */
int	_sunlink_stub2 () { return(0); };
#endif  /* CAMTEC_CCL */
#else	/* X25 */
int	_sunlink_stub () { return(0); };
#endif  /* X25 */

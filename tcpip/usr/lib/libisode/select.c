static char sccsid[] = "@(#)19	1.3  src/tcpip/usr/lib/libisode/select.c, isodelib7, tcpip411, GOLD410 4/5/93 16:34:21";
/*
 * COMPONENT_NAME: (ISODELIB7) ISODE Libraries, Release 7
 *
 * FUNCTIONS: selsocket set_check_fd xselect
 *
 * ORIGINS: 60
 *
 * FILE:	src/tcpip/usr/lib/libisode/select.c
 */

/* select.c - select() abstractions */

#ifndef	lint
static char *rcsid = "$Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/select.c,v 1.2 93/02/05 17:11:11 snmp Exp $";
#endif

/* 
 * $Header: /vikings/u/snmp/projects/harriet/RCS/src/tcpip/usr/lib/libisode/select.c,v 1.2 93/02/05 17:11:11 snmp Exp $
 *
 *
 * $Log:	select.c,v $
 * Revision 1.2  93/02/05  17:11:11  snmp
 * ANSI - D67743
 * 

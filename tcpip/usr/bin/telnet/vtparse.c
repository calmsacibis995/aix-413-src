static char sccsid[] = "@(#)88  1.3  src/tcpip/usr/bin/telnet/vtparse.c, tcptelnet, tcpip411, GOLD410 3/7/90 16:33:00";
/*
 * COMPONENT_NAME: TCPIP vtparse.c
 *
...
/* 
 * Written by:		Michael A. Petonic (mikep)
 *			SC18178 (``I am not a number!'' -Number9)
 * Date:		26 Jan 1989
 * Fixed to work by: 	Kent Malave' (kent)
 *			IBM Austin - "now we parse correctly"
 */

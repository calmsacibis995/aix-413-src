static char sccsid[] = "@(#)00	1.1  src/tcpip/usr/sbin/ipreport/rpc_prot.c, tcpras, tcpip411, GOLD410 10/11/91 13:34:02";
/* 
 * COMPONENT_NAME: TCPIP rpc_prot.c
 * 
 * FUNCTIONS: _seterr_reply, accepted, rejected, xdr_accepted_reply,
 *            xdr_callhdr, xdr_des_block, xdr_opaque_auth, xdr_rejected_reply, 
 *            xdr_replymsg 
 *
 * ORIGINS: 24 27
 *

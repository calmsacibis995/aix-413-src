static char sccsid[] = "@(#)18	1.6  src/tcpip/usr/sbin/mknamsv/mknamsv.c, tcpnaming, tcpip411, GOLD410 3/8/94 18:00:36";
/*
...
/*
 * mknamsv.c -  Takes parameters from SMIT interface and calls the NAMERSLV
...
#include <nl_types.h>
#include "mknamsv_msg.h"
#include <locale.h>
nl_catd catd;
extern *malloc();
#define MSGSTR(n,s) catgets(catd,MS_MKNAMSV,n,s)
	...
	char 	**argv;
{
	...
	setlocale(LC_ALL, "");
	catd = catopen(MF_MKNAMSV,NL_CAT_LOCALE);

#if !defined(lint)
static char sccsid[] = "@(#)65	1.6  src/tenplus/lib/short/i_write.c, tenplus, tenplus411, GOLD410 3/23/93 12:08:18";
#endif /* lint */
...
/****************************************************************************/
/* sht_write:  writes an integer array to a file                              */
...
int sht_write (register short *ip, register FILE *fp)
    ...
    (void) s_typecheck (ip, "sht_write", T_ATTR);

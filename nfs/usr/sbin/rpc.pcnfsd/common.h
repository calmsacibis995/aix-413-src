/*@(#)76  1.2  src/nfs/usr/sbin/rpc.pcnfsd/common.h, cmdnfs, nfs411, GOLD410 9/16/92 11:28:48;*/
/*
...
/*
**---------------------------------------------------------------------
** Define the following symbol to build a AIX V3.2 version
**---------------------------------------------------------------------
*/
#define OSVER_AIX32
...
#define AIX_STYLE_QUEUE
#define AIX_STYLE_CANCEL
#define AIX_STYLE_STATUS
#define AIX_STYLE_MONITOR
#define AIX
#define BPOPTLEN 256
#endif

static char sccsid[] = "@(#)17	1.1  src/bos/usr/sbin/adfutil/semafore.c, cmdadf, bos411, 9428A410j 8/20/93 10:22:35";
/*
...
int line;
{
    fprintf(stderr, NL_MSG(SEM_FATAL, "XXX FATAL ERROR: line %d, file %s: "), 
	line, file);
    perror("");
    exit(1);
}

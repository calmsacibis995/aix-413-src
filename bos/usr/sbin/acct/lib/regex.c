static char sccsid[] = "@(#)84	1.2  src/bos/usr/sbin/acct/lib/regex.c, cmdacct, bos411, 9428A410j 6/15/90 20:04:05";
/*
 * COMPONENT_NAME: (CMDACCT) Command Accounting
 *
 * FUNCTIONS: regex, __execute, __advance, __cclass, __xpush, __xpop
 *            __getrnge
 *
 * ORIGINS: 3, 9, 27
 *

static char sccsid[] = "@(#)05	1.7  src/bos/usr/sbin/cron/elm.c, cmdcntl, bos411, 9428A410j 4/25/91 17:16:51";
/*
...
/*
 * @OSF_COPYRIGHT@
static char rcsid[] = "RCSfile: elm.c,v Revision: 1.3 (OSF) Date: 90/10/07 22:06:26 ";
*/

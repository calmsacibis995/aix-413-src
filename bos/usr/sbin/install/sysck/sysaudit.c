static char sccsid[] = "@(#)07  1.2.1.3  src/bos/usr/sbin/install/sysck/sysaudit.c, cmdinstl, bos411, 9428A410j 1/15/94 17:50:39";
/*
...
char	*SYSCK_Check = "SYSCK_Check";
char	*SYSCK_Update = "SYSCK_Update";
char	*SYSCK_Install = "SYSCK_Install";
char	*Event;

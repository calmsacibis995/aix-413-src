static char sccsid[] = "@(#)00  1.1  src/bos/usr/sbin/install/migrate/vpdadd.c, cmdinstl, bos411, 9428A410j 1/5/94 16:28:38";
...
/* Begin vpdadd... */
  ...
  if (tbl_id == LPP_TABLE)              /* If adding to LPP table must  */
    {                                   /* set the lpp_id value based   */
                                        /* on vlaue in control record   */

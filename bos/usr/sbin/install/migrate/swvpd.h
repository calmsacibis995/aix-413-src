/* @(#)12  1.4  src/bos/usr/sbin/install/migrate/swvpd.h, cmdinstl, bos411, 9428A410j 4/28/94 10:28:35 */
...
#define  LPP_PTF                BIT(10)
#define  LPP_DESC               BIT(11)
#define  LPP_LPPID              BIT(12)
...
#define  PROD_CP_FLAG           BIT(2)
#define  PROD_FESN              BIT(3)
#define  PROD_NAME              BIT(4)
#define  PROD_STATE             BIT(5)
#define  PROD_VER               BIT(6)
#define  PROD_REL               BIT(7)
#define  PROD_MOD               BIT(8)
#define  PROD_FIX               BIT(9)
#define  PROD_PTF               BIT(10)
#define  PROD_MEDIA             BIT(11)
#define  PROD_SCEDED_BY         BIT(12)
#define  PROD_FIXINFO           BIT(13)
#define  PROD_PREREQ            BIT(14)
...
#define  ST_APPLY_HOLD		10
#define  ST_COMMIT_HOLD		11
...
#define  HIST_DECOMMIT          4
#define  HIST_CLEANUP           5

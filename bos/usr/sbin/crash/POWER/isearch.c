static char sccsid[] = "@(#)74	1.2  src/bos/usr/sbin/crash/POWER/isearch.c, cmdcrash, bos411, 9428A410j 5/26/93 15:26:45";
/*
 ...
 * NAME:  isearch
 *
 * FUNCTION:  reads instruction tables for disassembler information
 *
 *
...
isearch(instr,opcode,exop,format,xformat,AA,LK,SA,RC,OE,retstr,flag)
...
/*
** isearch_ppc -- reads instruction table for disassembler information
**

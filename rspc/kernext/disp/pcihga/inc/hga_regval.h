/* @(#)64  1.3  src/rspc/kernext/disp/pcihga/inc/hga_regval.h, pcihga, rspc411, GOLD410 4/29/94 12:05:56 */
/* hga_regval.h */
/*
...
/*
* COMPONENT NAME:    S3 PCI Device Driver include file
*
...
#define HGA_MAX_SIZE    0x00200000        /* Largest memory to attach */
#define HGA_RAM_2MEG    0x00200000        /* 2 Meg frame buffer */
#define HGA_RAM_1MEG    0x00100000        /* 1 Meg frame buffer */
...
#define BT485_REG_0_DATA      Bit7 | /* CR07 -- Cmd Reg 3 can be addressed */ \
...
#define BT485_REG_3_DATA      Bit2   /* CR32 -- 64 x 64 cursor             */

#define BT485_PXL_READ_MSK_DATA 0xff
#define BT485_ENB_CR3         Bit7   /* Enable access to CR 3              */

/*---------------------  Brooktree 485 Register Offsets  ---------------------*/
                                        /* 3210 -- RS                      */
#define BT485_RAMDAC_WR_ADDR 0x000003c8 /* 0000                            */
#define BT485_DAC_PALETTE    0x000003c9 /* 0001                            */
#define BT485_PIXEL_MASK     0x000003c6 /* 0010                            */
#define BT485_RAMDAC_RD_ADDR 0x000003c7 /* 0011                            */
#define BT485_COLOR_WR_ADDR  0x010003c8 /* 0100                            */
#define BT485_COLOR_DATA     0x010003c9 /* 0101                            */
#define BT485_COMMAND_0      0x010003c6 /* 0110                            */
#define BT485_COLOR_RD_ADDR  0x010003c7 /* 0111                            */
#define BT485_COMMAND_1      0x020003c8 /* 1000                            */
#define BT485_COMMAND_2      0x020003c9 /* 1001                            */
#define BT485_RAMDAC_STATUS  0x020003c6 /* 1010                            */
#define BT485_COMMAND_3      0x020003c6 /* 1010                            */
#define BT485_CUR_RAM_ARRAY  0x020003c7 /* 1011                            */
#define BT485_CUR_X_LOW_REG  0x030003c8 /* 1100                            */
#define BT485_CUR_X_HIGH_REG 0x030003c9 /* 1101                            */
#define BT485_CUR_Y_LOW_REG  0x030003c6 /* 1110                            */
#define BT485_CUR_Y_HIGH_REG 0x030003c7 /* 1111                            */

#define BT485_CUR_COLOR_DATA (volatile uchar *)(ld->IO_base_address | DAC_DATA)
#define BT485_CUR_ARRAY_DATA (volatile uchar *)(ld->IO_base_address | DAC_CURSOR_DATA)
#define BT485_DAC_X_LOW      (volatile uchar *)(ld->IO_base_address | DAC_X_LOW)
#define BT485_DAC_X_HIGH     (volatile uchar *)(ld->IO_base_address | DAC_X_HIGH)
#define BT485_DAC_Y_LOW      (volatile uchar *)(ld->IO_base_address | DAC_Y_LOW)
#define BT485_DAC_Y_HIGH     (volatile uchar *)(ld->IO_base_address | DAC_Y_HIGH)

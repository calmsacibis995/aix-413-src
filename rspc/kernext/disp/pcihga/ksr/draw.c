static char sccsid[] = "@(#)34  1.2  src/rspc/kernext/disp/pcihga/ksr/draw.c, pcihga, rspc411, GOLD410 4/21/94 17:47:43";
/* draw.c */
/*
 ...
 *
 * DESCRIPTIVE NAME:  color expand and output to characters to HGA VRAM
 *
 *
 ...
 *
 * DESCRIPTIVE NAME: Draw a character to the hga adapter.
 *
 * CALLED BY: Draw_text
 *
 * CALLS:     colex()

static char sccsid[] = "@(#)36  1.1  src/rspc/kernext/disp/pcihga/ksr/hga_err.c, pcihga, rspc411, GOLD410 4/15/94 18:22:48";
/* hga_err.c */
/*
...
int
hga_err(vp,res_name,dmodule,fmodule,return_code,err_indicator,ras_unique)
struct vtmstruc *vp;
char   *res_name;
char   *dmodule;
char   *fmodule;
...
/* For debugging purposes only  */
       BUGLPR(dbg_hga_err, BUGNFO, ("Entering hga_err \n"));
if( res_name != NULL )
       BUGLPR(dbg_hga_err, BUGNFO, ("Failing component %s\n",res_name));
if( dmodule != NULL )
       BUGLPR(dbg_hga_err, BUGNFO, ("Detecting module %s \n",dmodule));
if( fmodule != NULL ) {
       BUGLPR(dbg_hga_err, BUGNFO, ("Failing module %s\n",fmodule));
       BUGLPR(dbg_hga_err, BUGNFO, ("Return code %d\n",return_code));
       }
if( err_indicator != NULL )
       BUGLPR(dbg_hga_err, BUGNFO, ("Ras error code %d\n",err_indicator));
if( ras_unique != NULL )
       BUGLPR(dbg_hga_err, BUGNFO, ("Ras_unique %s\n",ras_unique));
...
/* For debug only */
BUGLPR(dbg_hga_err, BUGNFO, ("Leaving hga_err \n"));

static char sccsid[] = "@(#)53  1.4  src/rspc/kernext/disp/pcihga/ksr/vtt_term.c, pcihga, rspc411, 9436D411a 9/6/94 18:20:37";
/* vtt_term.c */
/*
...
BUGLPR(dbg_vttterm,BUGGID,("vp->display->free_area = 0x%x\n",vp->display->free_area));
  ...
  ******************************/
  ...
  vp->display->current_dpm_phase = 0;  /* reset for Display Power Management */

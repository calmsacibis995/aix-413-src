static char sccsid[] = "@(#)10  1.3  src/rspc/kernext/disp/pcigga/ksr/vtt_clr.c, pcigga, rspc41J, 9513A_all 3/22/95 11:15:14";
/* vtt_clr.c */
/*
based on "@(#)49  1.3  src/bos/kernext/disp/wga/ksr/vtt_clr.c, bos, bos410 10/28/93 17:47:31";
 *
...

{
  ...
  GGA_ENTER_TRC0(ddf,gga_vttclr,2,GGA_VTTCLR);
      ...
      (ld->Vttenv.vtt_mode != KSR_MODE)
  {
     ...
     /*------------------------------------*/
     GGA_EXIT_TRC1(ddf,gga_vttclr,2,GGA_VTTCLR,EIO);
     return(EIO);
  }
  ...
  ********************************************************************/
  ...
  for (i = 0; i<height; i++)
  {
    ...
    ****************/
    ...
    {
      GGA_PARM_TRC0(ddf,gga_vttclr,2,GGA_VTTCLR,GGA_VTTCLR_UPDATE_FB);
  ...
  {
    GGA_PARM_TRC0(ddf,gga_vttclr,2,GGA_VTTCLR,GGA_VTTCLR_CALL_MOVC);
    vttmovc(vp);
  }

  GGA_EXIT_TRC0(ddf,gga_vttclr,2,GGA_VTTCLR);

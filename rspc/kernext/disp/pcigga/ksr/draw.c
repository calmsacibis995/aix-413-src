static char sccsid[] = "@(#)00  1.1  src/rspc/kernext/disp/pcigga/ksr/draw.c, pcigga, rspc411, 9435D411a 9/2/94 16:06:35";
/* draw.c */
/*
based on "@(#)38  1.3  src/bos/kernext/disp/wga/ksr/draw.c, bos, bos410 10/28/93 17:38:22";
 *
 ...
 *
 * DESCRIPTIVE NAME:  color expand and output to characters to GGA VRAM
 *
 *
 ...
 *
 * DESCRIPTIVE NAME: Draw a character to the gga adapter.
 *
 * CALLED BY: Draw_text
 *
 * CALLS:     colex()
                        ...
                        xstart;
{
	...
	ld->bus_mem_addr = PCI_MEM_ATT(&ddf->pci_mem_map);
        ...
        BUGLPR (dbg_clrlines, BUGGID, ("linelen =0x%8.8x\n",linelen));

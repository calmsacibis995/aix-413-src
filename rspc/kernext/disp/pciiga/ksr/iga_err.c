static char sccsid[] = "@(#)54	1.1  src/rspc/kernext/disp/pciiga/ksr/iga_err.c, pciiga, rspc411, 9436D411b 9/5/94 16:30:47";
/*
 *
...
int
iga_err(vp,res_name,dmodule,fmodule,return_code,err_indicator,ras_unique)
struct vtmstruc *vp;
char   *res_name;
char   *dmodule;
char   *fmodule;
...
/* For debugging purposes only  */
       BUGLPR(dbg_iga_err, BUGNFO, ("Entering iga_err \n"));
if( res_name != NULL )
       BUGLPR(dbg_iga_err, BUGNFO, ("Failing component %s\n",res_name));
if( dmodule != NULL )
       BUGLPR(dbg_iga_err, BUGNFO, ("Detecting module %s \n",dmodule));
if( fmodule != NULL ) {
       BUGLPR(dbg_iga_err, BUGNFO, ("Failing module %s\n",fmodule));
       BUGLPR(dbg_iga_err, BUGNFO, ("Return code %d\n",return_code));
       }
if( err_indicator != NULL )
       BUGLPR(dbg_iga_err, BUGNFO, ("Ras error code %d\n",err_indicator));
if( ras_unique != NULL )
       BUGLPR(dbg_iga_err, BUGNFO, ("Ras_unique %s\n",ras_unique));
...
/* For debug only */
BUGLPR(dbg_iga_err, BUGNFO, ("Leaving iga_err \n"));

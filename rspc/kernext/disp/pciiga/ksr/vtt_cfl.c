static char sccsid[] = "@(#)61	1.3  src/rspc/kernext/disp/pciiga/ksr/vtt_cfl.c, pciiga, rspc41J, 9515B_all 3/22/95 17:08:41";
/*
 *
...
BUGLPR(dbg_vttcfl,BUGGID,("cursor_show       = %d\n",cursor_show));
	...
	IGA_ENTER_TRC0(ddf,iga_vttcfl,2,IGA_VTTCFL);
        ...
        {
		IGA_EXIT_TRC1(ddf,iga_vttcfl,2,IGA_VTTCFL,EIO);
                return (EIO);
        }
...
BUGLPR (dbg_vttcfl, BUGGID, ("Destination address = 0x%x \n",(buf_addr + ((d_offset + ld->Scroll_offset) % ld->Vttenv.ps_words))));
        ...
        {
		IGA_PARM_TRC0(ddf,iga_vttcfl,2,IGA_VTTCFL,IGA_VTTCFL_UPDATE_FB);
		...
		IGA_PARM_TRC0(ddf,iga_vttcfl,2,IGA_VTTCFL,IGA_VTTCFL_CALL_MOVC);
	...
	IGA_EXIT_TRC0(ddf,iga_vttcfl,2,IGA_VTTCFL);

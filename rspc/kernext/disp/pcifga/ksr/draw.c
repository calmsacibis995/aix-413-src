static char sccsid[] = "@(#)14  1.2  src/rspc/kernext/disp/pcifga/ksr/draw.c, pcifga, rspc411, GOLD410 4/21/94 18:26:11";
/* draw.c */
/*
 ...
 *
 * DESCRIPTIVE NAME:  color expand and output to characters to FGA VRAM
 *
 *
 ...
 *
 * DESCRIPTIVE NAME: Draw a character to the fga adapter.
 *
 * CALLED BY: Draw_text
 *
 * CALLS:     colex()

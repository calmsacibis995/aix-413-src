...
/* ************************************************************************* */
/* *                 System Environment Definition Section                 * */
/* ************************************************************************* */
/* -------- */
/*  System  */
/* -------- */
#define  SYSTEM_6030                      TRUE
                         /* PowerSeries (6030) product system flag (default) */
#define  SYSTEM_BIGENDIAN                 TRUE     /* Big-endian system flag */
                                               /* Big = TRUE, Little = FALSE */

/* ------- */
/*  Clock  */
/* ------- */
#define  CLOCK_CPUMAXSPEED                (100)
                                   /* CPU internal maximam speed (MHz) value */
#define  CLOCK_CPUBUSSPEED                (33)
                                                /* CPU-bus speed (MHz) value */
#define  CLOCK_PCIBUSSPEED                (33)
                                                /* PCI-bus speed (MHz) value */

/* -------- */
/*  Switch  */
/* -------- */
#define  SWITCH_SWPOWER                   TRUE
                                               /* Software power switch flag */
#define  SWITCH_LID                       TRUE
                                                          /* LID switch flag */

/* ------------------ */
/*  Power management  */
/* ------------------ */
#define  PM_SUSPENDSUPPORT                TRUE
                                                     /* Suspend support flag */
#define  PM_ALARMRESUMESUPPORT            TRUE
                                             /* Resume by alarm support flag */
#define  PM_ALARMWAKEUPSUPPORT            FALSE
                                            /* Wake-up by alarm support flag */

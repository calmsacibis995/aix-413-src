/* @(#)18	1.2  src/rspc/kernext/pm/pmmd/IBM8301/pdpic.h, pwrsysx, rspc41J, 9515B_all 4/14/95 10:55:38  */
/*
...
#define  MSGPIC_READ_ELCR1                (0x000A)
                                       /* Read edge/level control 1 register */
#define  MSGPIC_READ_ELCR2                (0x000B)
                                       /* Read edge/level control 2 register */
#define  MSGPIC_WRITE_ELCR1               (0x000C)
                                      /* Write edge/level control 1 register */
#define  MSGPIC_WRITE_ELCR2               (0x000D)

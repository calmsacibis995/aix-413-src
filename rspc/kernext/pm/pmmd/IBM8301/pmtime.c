static char sccsid[] = "@(#)35	1.2  src/rspc/kernext/pm/pmmd/IBM8301/pmtime.c, pwrsysx, rspc41J, 9515B_all 4/14/95 10:56:11";
/*
...
write_rtc(int reg, char value)
{
   	volatile uchar  *io;
         ...
         * I/O access start
         */
        io = (volatile uchar *)iomem_att(&(pm_md_data.pm_RTC_data.map))
                                                + pm_md_data.pm_RTC_data.base;

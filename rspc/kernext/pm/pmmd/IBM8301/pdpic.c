static char sccsid[] = "@(#)17	1.2  src/rspc/kernext/pm/pmmd/IBM8301/pdpic.c, pwrsysx, rspc41J, 9515B_all 4/14/95 10:55:36";
/*
...
#define  PORTPIC_ELCR1                    (0x4D0)
                                            /* Edge/Level control 1 register */
#define  PORTPIC_ELCR2                    (0x4D1)
      ...
      default:
         ...
         switch(SelectMessage(*pmMsg))
         {
            ...
            case MSGPIC_WRITE_OCW3:
               ...
               rc  = ERRPIC_NOERROR;
               break;
            case MSGPIC_READ_ELCR1:
            case MSGPIC_WRITE_ELCR1:
               off = PORTPIC_ELCR1;
               rc  = ERRPIC_NOERROR;
               break;
            case MSGPIC_READ_ELCR2:
            case MSGPIC_WRITE_ELCR2:
               off = PORTPIC_ELCR2;
               rc  = ERRPIC_NOERROR;
               break;
            default:
             ...
             POBJCOMMON poObj)                   /* Pointer to Common object */
{
   ...
   switch(SelectMessage(*pmMsg))
   {
      ...
      case MSGPIC_SAVE_CONTEXT:
         ...
         BuildMsg(msg, MSGPIC_READ_ELCR1);
         SendMsg(msg, *ppicio);
         if(!SelectResult(msg))
         {
            ppicctl->chElcr1 = (BYTE)SelectParm1(msg);
         }
         else
         {
            rc = SelectResult(msg);
         ...
         BuildMsg(msg, MSGPIC_READ_ELCR2);
         SendMsg(msg, *ppicio);
         if(!SelectResult(msg))
         {
            ppicctl->chElcr2 = (BYTE)SelectParm1(msg);
         }
         else
         {
            rc = SelectResult(msg);
      ...
      case MSGPIC_RESTORE_CONTEXT:
         ...
         BuildMsgWithParm1(msg, MSGPIC_WRITE_ELCR1,
                                ppicctl->chElcr1);
         SendMsg(msg, *ppicio);
         if(SelectResult(msg))
         {
         ...
         BuildMsgWithParm1(msg, MSGPIC_WRITE_ELCR2,
                                ppicctl->chElcr2);
         SendMsg(msg, *ppicio);
         if(SelectResult(msg))
         {

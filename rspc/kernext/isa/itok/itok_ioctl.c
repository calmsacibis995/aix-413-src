static char sccsid[] = "@(#)48	1.8  src/rspc/kernext/isa/itok/itok_ioctl.c, isatok, rspc41J, 9516B_all 4/20/95 20:00:29";
/*
	      ...
	      int     length)	/* length of argument for this command.     */
{
  ...
  case NDD_ADD_FILTER: {		/* Add a service access point. */
    ...
    if (!WRK.sap_allocated[filter.dsap]) {
      ...
      WRK.sap_dsap[filter.dsap]=filter.dsap;

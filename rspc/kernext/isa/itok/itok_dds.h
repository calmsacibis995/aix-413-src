/* @(#)55	1.4  src/rspc/kernext/isa/itok/itok_dds.h, isatok, rspc41J, 9516B_all 4/21/95 10:27:15 */
/*
...
typedef struct {
  ...
  u_char        sap_dsap[255];      /* saved dsap for each SAP for pwr mgmt */
  /* ______________________________________________________________________ */
  /*                        Wait event flags                                */
...
#define TOK_WAKEUP_BIT			0x80
  ...
  ushort          network_status;     /* Used when reporting MIBS info.     */
    /* Power Management */
  int             pm_state;           /* holds the state of the device      */
                                      /* prior to a suspend/hibernate       */

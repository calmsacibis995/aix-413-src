/* @(#)57	1.5  src/rspc/kernext/isa/itok/itok_misc.h, isatok, rspc41J, 9516B_all 4/21/95 10:36:37 */
/*
...
/* we have defined 2 transmit buffers of length 2048, but the hardware
   reserves the first 6 bytes of the buffer, so we can only use 2042
*/
#define TOK_4M_MAX_DATA		2042  /* 4096 Really. */
#define TOK_16M_MAX_DATA	2042  /* 18000 Really. */
...
#define TRACE_SYS(hook, tag, arg1, arg2, arg3)  \
        tok_save_trace((hook << 20) | HKTY_GT | 4, tag, arg1, arg2, arg3)

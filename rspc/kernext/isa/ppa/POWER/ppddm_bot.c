#ifndef lint
static char sccsid[] = "@(#)41 1.8 src/rspc/kernext/isa/ppa/POWER/ppddm_bot.c, sysxprnt, rspc41J, 9510A 3/6/95 23:23:32";
#endif
/*
 ...
 *		pprestart_tmr
 *
 *              ppreadstat (moved to ppddb.c)
 *              ppwritedata (moved to ppddb.c)
 *              ppreadchar (moved to pppio_bot.c)
 *
 *   ORIGINS: 27, 83
 *

#ifndef lint
static char sccsid[] = "@(#)06 1.25 src/rspc/kernext/isa/ppa/ppddb.c, sysxprnt, rspc41J, 9510A 3/6/95 23:22:40";
#endif
/*
 ...
 *              ppready
 *		pppulst
 *              ppreaddata (moved from ppddt.c)
 *              ppreadctrl
 *              ppreadstat (moved from ppddm_bot.c)
 *              ppwritedata (moved from ppddm_bot.c)
 *              ppwritectrl
 *              ppwritestat
 *		ppdelay
 *

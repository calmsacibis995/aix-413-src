/* @(#)35        1.1  src/rspc/kernext/isa/dartic_isa/darticdd_isa.h, dd_artic, rspc41J, 9508A_notx 2/15/95 14:35:28
 *
...
typedef struct
{
    struct io_map map_io;   /* ISA memory map for I/O access            */
    struct io_map map_mem;  /* ISA memory map for Bus memory access     */
} DARTIC_ISA;
#endif

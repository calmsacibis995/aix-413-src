static char sccsid[] = "@(#)88  1.6  src/rspc/kernext/pcmcia/ent/ient_open.c, pcmciaent, rspc41J, 9516A_all 4/18/95 00:54:09";
/*
static char sccsid[] = "@(#)78  1.4.1.1  src/rspc/kernext/isa/ient/ient_open.c, isaent, rspc41J 1/6/95 15:47:10";
*/
/*
...
#ifdef PCMCIAENT
  if ( p_dds->no_card ) {
    TRACE_BOTH(HKWD_IEN_ISA_ERR,"OPN+",(ulong)p_dds,(ulong)ENOCONNECT,
      (ulong)WRK.adap_state);
    return(ENOCONNECT);
  }
#endif
...
ient_setup(dds_t *p_dds)       /* Device structure ptr. */
{
    ...
    WRK.receiving         = FALSE;
    WRK.do_send           = FALSE;
    WRK.new_packet        = IEN_ISA_NBR_TX_PAGES + 1;

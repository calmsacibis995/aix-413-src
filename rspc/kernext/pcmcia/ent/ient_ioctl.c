static char sccsid[] = "@(#)85  1.4  src/rspc/kernext/pcmcia/ent/ient_ioctl.c, pcmciaent, rspc41J, 9512A_all 3/16/95 19:27:57";
/*
static char sccsid[] = "@(#)76  1.5.1.1  src/rspc/kernext/isa/ient/ient_ioctl.c, isaent, rspc41J 1/6/95 15:47:04";
*/
/*
    ...
    switch (cmd)
    {
        ...
        */
        ...
        case NDD_GET_ALL_STATS: 
        {
            ...
            bcopy(&NDD.ndd_genstats, arg, sizeof(ndd_genstats_t));
            bcopy(&(ENTSTATS), arg + sizeof(ndd_genstats_t), 
                   sizeof(ent_genstats_t) + sizeof(ien_isa_all_stats_t));
...
ient_getstat(dds_t *p_dds)    /* Device structure pointer. */
{
    ...
    ENTSTATS.hw_txq_len               = WRK.tx_buf_in_use;

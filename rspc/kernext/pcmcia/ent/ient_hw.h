/* @(#)82       1.2  src/rspc/kernext/pcmcia/ent/ient_hw.h, pcmciaent, rspc41J, 9511A_all 3/9/95 03:03:31 */
/* @(#)63       1.1.1.1  src/rspc/kernext/isa/ient/ient_hw.h, isaent, rspc41J 1/6/95 15:46:37 */
/*
...
#ifndef PCMCIAENT       /**************** Don't use following on PCMCIA *******/
...
#ifdef PCMCIAENT
/* NIC Register offsets in page 0. offset is changed on PCMCIA card */
#define PAGE0_COMMAND   0x00            /* Command register                RW */
#define PAGE0_CLDA0     0x01            /* Current local DMA address 0     RO */
#define PAGE0_PSTART    PAGE0_CLDA0     /* Page Start register             WO */
#define PAGE0_CLDA1     0x02            /* Current local DMA address 1     RO */
#define PAGE0_PSTOP     PAGE0_CLDA1     /* Page Stop register              WO */
#define PAGE0_BNRY      0x03            /* Boundary Pointer                RW */
#define PAGE0_TSR       0x04            /* Transmit Status register        RO */
#define PAGE0_TPSR      PAGE0_TSR       /* Transmit Page Start Address     WO */
#define PAGE0_NCR       0x05            /* Number of collisions register   RO */
#define PAGE0_TBCR0     PAGE0_NCR       /* Transmit Byte count register 0  WO */
#define PAGE0_FIFO      0x06            /* FIFO buffer register            RO */
#define PAGE0_TBCR1     PAGE0_FIFO      /* Transmit Byte count register 1  WO */
#define PAGE0_ISR       0x07            /* Interrupt status register       RW */
#define PAGE0_CRDA0     0x08            /* Current Remote DMA address 0    RO */
#define PAGE0_RSAR0     PAGE0_CRDA0     /* Remote Start Address register 0 WO */
#define PAGE0_CRDA1     0x09            /* Current Remote DMA address 1    WO */
#define PAGE0_RSAR1     PAGE0_CRDA1     /* Remote Start Address register 1 WO */
#define PAGE0_RBCR0     0x0A            /* Remote byte count register 0    WO */
#define PAGE0_RBCR1     0x0B            /* Remote byte count register 1    WO */
#define PAGE0_RSR       0x0C            /* Receive status register         RO */
#define PAGE0_RCR       PAGE0_RSR       /* Receive configuration register  WO */
#define PAGE0_CNTR0     0x0D            /* Tally Counter 0 (Align. errors) RO */
#define PAGE0_TCR       PAGE0_CNTR0     /* Transmit configuration register WO */
#define PAGE0_CNTR1     0x0E            /* Tally Counter 1 (CRC errors)    RO */
#define PAGE0_DCR       PAGE0_CNTR1     /* Data configuration register     WO */
#define PAGE0_CNTR2     0x0F            /* Tally Counter 2 (Missed packets)RO */
...
#ifdef PCMCIAENT
/* NIC Register offsets in page 1. offset is changed on PCMCIA card */
#define PAGE1_COMMAND   0x00            /* Command register                RW */
#define PAGE1_PAR0      0x01            /* Physical address register 0     RW */
#define PAGE1_PAR1      0x02            /* Physical address register 1     RW */
#define PAGE1_PAR2      0x03            /* Physical address register 2     RW */
#define PAGE1_PAR3      0x04            /* Physical address register 3     RW */
#define PAGE1_PAR4      0x05            /* Physical address register 4     RW */
#define PAGE1_PAR5      0x06            /* Physical address register 5     RW */
#define PAGE1_CURR      0x07            /* Current page (receive unit)     RW */
#define PAGE1_MAR0      0x08            /* Multicast address register 0    RW */
#define PAGE1_MAR1      0x09            /* Multicast address register 1    RW */
#define PAGE1_MAR2      0x0A            /* Multicast address register 2    RW */
#define PAGE1_MAR3      0x0B            /* Multicast address register 3    RW */
#define PAGE1_MAR4      0x0C            /* Multicast address register 4    RW */
#define PAGE1_MAR5      0x0D            /* Multicast address register 5    RW */
#define PAGE1_MAR6      0x0E            /* Multicast address register 6    RW */
#define PAGE1_MAR7      0x0F            /* Multicast address register 7    RW */
#else
...
#ifdef PCMCIAENT
/* NIC Register offsets in page 2. offset change on PCMCIA mode*/
/* Page 2 registers are ONLY used for diagnostic purposes. */
#define PAGE2_COMMAND   0x00            /* Command register                RW */
#define PAGE2_PSTART    0x01            /* Page Start Register             RO */
#define PAGE2_CLDA0     PAGE2_PSTART    /* Current Local DMA Address 0     WO */
#define PAGE2_PSTOP     0x02            /* Page Stop Register              RW */
#define PAGE2_CLDA1     PAGE2_PSTOP     /* Current Local DMA Address 1     WO */
#define PAGE2_RNPP      0x03            /* Remote Next Packet Pointer      RW */
#define PAGE2_TPSR      0x04            /* Transmit Page Start Address     RO */
#define PAGE2_LNPP      0x05            /* Local Next Packet Pointer       RW */
#define PAGE2_ACUP      0x06            /* Address counter (upper)         RW */
#define PAGE2_ACLOW     0x07            /* Address counter (lower)         RW */
#define PAGE2_RCR       0x0C            /* Receive Configuration register  RO */
#define PAGE2_TCR       0x0D            /* Transmit Configuration register RO */
#define PAGE2_DCR       0x0E            /* Data Configuration register     RO */
#define PAGE2_IMR       0x0F            /* Interrupt Mask register         RO */
#else
...
#ifdef PCMCIAENT
#define IEN_PCMCIA_ENB_ALL_INTR IEN_ISA_ENB_ALL_INTR & (~IEN_ISA_ENB_DMA_COMP)
#endif
...
#ifdef PCMCIAENT
#define PACKET_BUFFER_ADDRESS   0x4000
#define IEN_ISA_NBR_TX_PAGES    ((PACKET_BUFFER_ADDRESS >> 8)+0x6)
#define INTR_FLAG_RESET         0x00
#define INTR_FLAG_OWN         	0x01
#else
#define IEN_ISA_NBR_TX_PAGES    0x06
#endif

#define IEN_ISA_HIGHEST_TX_PAGE (IEN_ISA_NBR_TX_PAGES - 1)

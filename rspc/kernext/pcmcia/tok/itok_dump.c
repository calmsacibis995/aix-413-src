static char sccsid[] = "@(#)58  1.2  src/rspc/kernext/pcmcia/tok/itok_dump.c, pcmciatok, rspc41J, 9511A_all 3/9/95 02:36:40";
/*
static char sccsid[] = "@(#)53	1.2  src/rspc/kernext/isa/itok/itok_dump.c, isatok, rspc41J 5/21/94 15:32:49";
 */
/*
 *   COMPONENT_NAME: PCMCIATOK - 16/4 PowerPC Token-ring driver
 *
                 ...
                 struct mbuf *p_mbuf) /* Data to transmit.                    */
{
  ...
  srb_ptr = memaddr + DDI.bus_id,DDI.shared_mem_addr + WRK.srb.offset;

static char sccsid[] = "@(#)34	1.1  src/rspc/usr/lbin/stok_dd/main.c, pcitok, rspc41J, 9513A_all 3/24/95 15:13:18";
/*
 ...
 * NAME:     main
 *
 * FUNCTION: The main routine of the pcitok dump formatter.

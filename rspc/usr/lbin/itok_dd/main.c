static char sccsid[] = "@(#)35	1.1  src/rspc/usr/lbin/itok_dd/main.c, isatok, rspc411, 9435A411a 8/29/94 16:33:52";
/*
 ...
 * NAME:     main
 *
 * FUNCTION: The main routine of the isaent dump formatter.

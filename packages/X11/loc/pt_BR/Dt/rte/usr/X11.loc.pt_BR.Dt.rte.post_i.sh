#!/bin/ksh
# @(#)44        1.2  src/packages/X11/loc/pt_BR/Dt/rte/usr/X11.loc.pt_BR.Dt.rte.post_i.sh, pkgxcde, pkg411, 9434B411a 8/24/94 13:46:41
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/pt_BR || exit 1

#!/bin/ksh
# @(#)18        1.1  src/packages/X11/loc/sv_SE/Dt/rte/usr/X11.loc.sv_SE.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9432A411a 8/4/94 20:19:05
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/sv_SE/*

#!/bin/ksh
# @(#)17        1.1  src/packages/X11/loc/sv_SE/Dt/rte/usr/X11.loc.sv_SE.Dt.rte.post_i.sh, pkgxcde, pkg411, 9432A411a 8/4/94 20:19:03
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/sv_SE || exit 1

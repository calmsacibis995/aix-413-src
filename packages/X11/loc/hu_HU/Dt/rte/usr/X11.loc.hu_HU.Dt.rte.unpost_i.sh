#!/bin/ksh
# @(#)33        1.1  src/packages/X11/loc/hu_HU/Dt/rte/usr/X11.loc.hu_HU.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9433B411a 8/11/94 16:28:01
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/hu_HU/*

#!/bin/ksh
# @(#)32        1.2  src/packages/X11/loc/hu_HU/Dt/rte/usr/X11.loc.hu_HU.Dt.rte.post_i.sh, pkgxcde, pkg411, 9434B411a 8/24/94 13:46:06
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/hu_HU || exit 1

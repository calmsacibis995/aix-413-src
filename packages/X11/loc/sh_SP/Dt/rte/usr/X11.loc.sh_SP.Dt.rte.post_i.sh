#!/bin/ksh
# @(#)52        1.2  src/packages/X11/loc/sh_SP/Dt/rte/usr/X11.loc.sh_SP.Dt.rte.post_i.sh, pkgxcde, pkg411, 9434B411a 8/24/94 13:47:01
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/sh_SP || exit 1

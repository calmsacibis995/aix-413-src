#!/bin/ksh
# @(#)53        1.1  src/packages/X11/loc/sh_SP/Dt/rte/usr/X11.loc.sh_SP.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9433B411a 8/11/94 16:29:12
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/sh_SP/*

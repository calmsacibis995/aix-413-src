#!/bin/ksh
# @(#)05        1.1  src/packages/X11/loc/fr_FR/Dt/rte/usr/X11.loc.fr_FR.Dt.rte.post_i.sh, pkgxcde, pkg411, 9432A411a 8/4/94 20:18:36
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/fr_FR || exit 1

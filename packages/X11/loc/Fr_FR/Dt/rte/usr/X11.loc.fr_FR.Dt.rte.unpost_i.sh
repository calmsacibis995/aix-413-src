#!/bin/ksh
# @(#)06        1.1  src/packages/X11/loc/fr_FR/Dt/rte/usr/X11.loc.fr_FR.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9432A411a 8/4/94 20:18:38
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/fr_FR/*

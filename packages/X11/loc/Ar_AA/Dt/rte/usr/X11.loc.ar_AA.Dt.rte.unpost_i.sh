#!/bin/ksh
# @(#)09        1.1  src/packages/X11/loc/ar_AA/Dt/rte/usr/X11.loc.ar_AA.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9433B411a 8/11/94 16:26:10
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/ar_AA/*

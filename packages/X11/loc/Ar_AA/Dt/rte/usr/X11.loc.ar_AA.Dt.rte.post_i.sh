#!/bin/ksh
# @(#)08        1.2  src/packages/X11/loc/ar_AA/Dt/rte/usr/X11.loc.ar_AA.Dt.rte.post_i.sh, pkgxcde, pkg411, 9434B411a 8/24/94 13:45:06
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/ar_AA || exit 1

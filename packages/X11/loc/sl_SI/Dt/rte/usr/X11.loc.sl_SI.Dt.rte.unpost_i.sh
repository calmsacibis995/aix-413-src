#!/bin/ksh
# @(#)57        1.1  src/packages/X11/loc/sl_SI/Dt/rte/usr/X11.loc.sl_SI.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9433B411a 8/11/94 16:29:19
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/sl_SI/*

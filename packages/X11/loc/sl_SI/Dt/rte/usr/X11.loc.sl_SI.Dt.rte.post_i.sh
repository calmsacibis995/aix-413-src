#!/bin/ksh
# @(#)56        1.2  src/packages/X11/loc/sl_SI/Dt/rte/usr/X11.loc.sl_SI.Dt.rte.post_i.sh, pkgxcde, pkg411, 9434B411a 8/24/94 13:47:10
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/sl_SI || exit 1

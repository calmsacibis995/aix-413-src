#!/bin/ksh
# @(#)14        1.1  src/packages/X11/loc/nl_BE/Dt/rte/usr/X11.loc.nl_BE.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9432A411a 8/4/94 20:18:55
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/nl_BE/*

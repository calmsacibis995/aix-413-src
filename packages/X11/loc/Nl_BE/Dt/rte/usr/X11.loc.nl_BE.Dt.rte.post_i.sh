#!/bin/ksh
# @(#)13        1.1  src/packages/X11/loc/nl_BE/Dt/rte/usr/X11.loc.nl_BE.Dt.rte.post_i.sh, pkgxcde, pkg411, 9432A411a 8/4/94 20:18:53
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/nl_BE || exit 1

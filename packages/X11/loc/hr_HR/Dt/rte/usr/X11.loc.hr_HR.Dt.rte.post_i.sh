#!/bin/ksh
# @(#)30        1.2  src/packages/X11/loc/hr_HR/Dt/rte/usr/X11.loc.hr_HR.Dt.rte.post_i.sh, pkgxcde, pkg411, 9434B411a 8/24/94 13:46:01
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/hr_HR || exit 1

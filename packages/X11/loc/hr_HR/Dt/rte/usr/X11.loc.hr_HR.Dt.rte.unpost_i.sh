#!/bin/ksh
# @(#)31        1.1  src/packages/X11/loc/hr_HR/Dt/rte/usr/X11.loc.hr_HR.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9433B411a 8/11/94 16:27:52
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/hr_HR/*

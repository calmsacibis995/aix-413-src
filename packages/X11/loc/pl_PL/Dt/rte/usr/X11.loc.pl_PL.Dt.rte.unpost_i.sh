#!/bin/ksh
# @(#)43        1.1  src/packages/X11/loc/pl_PL/Dt/rte/usr/X11.loc.pl_PL.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9433B411a 8/11/94 16:28:45
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/pl_PL/*

#!/bin/ksh
# @(#)42        1.2  src/packages/X11/loc/pl_PL/Dt/rte/usr/X11.loc.pl_PL.Dt.rte.post_i.sh, pkgxcde, pkg411, 9434B411a 8/24/94 13:46:35
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/pl_PL || exit 1

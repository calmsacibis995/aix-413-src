#!/bin/ksh
# @(#)39        1.1  src/packages/X11/loc/mk_MK/Dt/rte/usr/X11.loc.mk_MK.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9433B411a 8/11/94 16:28:28
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/mk_MK/*

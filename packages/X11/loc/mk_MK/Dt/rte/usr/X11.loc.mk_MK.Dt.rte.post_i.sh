#!/bin/ksh
# @(#)38        1.2  src/packages/X11/loc/mk_MK/Dt/rte/usr/X11.loc.mk_MK.Dt.rte.post_i.sh, pkgxcde, pkg411, 9434B411a 8/24/94 13:46:23
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/mk_MK || exit 1

#!/bin/ksh
# @(#)36        1.2  src/packages/X11/loc/iw_IL/Dt/rte/usr/X11.loc.iw_IL.Dt.rte.post_i.sh, pkgxcde, pkg411, 9434B411a 8/24/94 13:46:16
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/iw_IL || exit 1

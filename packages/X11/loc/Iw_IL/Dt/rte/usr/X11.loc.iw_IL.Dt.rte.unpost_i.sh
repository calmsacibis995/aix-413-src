#!/bin/ksh
# @(#)37        1.1  src/packages/X11/loc/iw_IL/Dt/rte/usr/X11.loc.iw_IL.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9433B411a 8/11/94 16:28:20
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/iw_IL/*

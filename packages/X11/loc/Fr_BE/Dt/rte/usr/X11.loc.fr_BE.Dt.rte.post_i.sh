#!/bin/ksh
# @(#)24        1.2  src/packages/X11/loc/fr_BE/Dt/rte/usr/X11.loc.fr_BE.Dt.rte.post_i.sh, pkgxcde, pkg411, 9434B411a 8/24/94 13:45:45
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/fr_BE || exit 1

#!/bin/ksh
# @(#)25        1.1  src/packages/X11/loc/fr_BE/Dt/rte/usr/X11.loc.fr_BE.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9433B411a 8/11/94 16:27:27
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/fr_BE/*

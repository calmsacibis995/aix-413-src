#!/bin/ksh
# @(#)60        1.2  src/packages/X11/loc/tr_TR/Dt/rte/usr/X11.loc.tr_TR.Dt.rte.post_i.sh, pkgxcde, pkg411, 9434B411a 8/24/94 13:48:26
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/tr_TR || exit 1

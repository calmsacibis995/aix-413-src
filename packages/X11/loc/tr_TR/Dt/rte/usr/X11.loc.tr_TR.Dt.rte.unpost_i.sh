#!/bin/ksh
# @(#)61        1.1  src/packages/X11/loc/tr_TR/Dt/rte/usr/X11.loc.tr_TR.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9433B411a 8/11/94 16:29:29
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/tr_TR/*

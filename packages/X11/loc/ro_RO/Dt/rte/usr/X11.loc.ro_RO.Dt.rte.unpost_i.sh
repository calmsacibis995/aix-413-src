#!/bin/ksh
# @(#)49        1.1  src/packages/X11/loc/ro_RO/Dt/rte/usr/X11.loc.ro_RO.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9433B411a 8/11/94 16:29:04
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/ro_RO/*

#!/bin/ksh
# @(#)48        1.2  src/packages/X11/loc/ro_RO/Dt/rte/usr/X11.loc.ro_RO.Dt.rte.post_i.sh, pkgxcde, pkg411, 9434B411a 8/24/94 13:46:50
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/ro_RO || exit 1

#!/bin/ksh
# @(#)28        1.2  src/packages/X11/loc/fr_CH/Dt/rte/usr/X11.loc.fr_CH.Dt.rte.post_i.sh, pkgxcde, pkg411, 9434B411a 8/24/94 13:45:56
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/fr_CH || exit 1

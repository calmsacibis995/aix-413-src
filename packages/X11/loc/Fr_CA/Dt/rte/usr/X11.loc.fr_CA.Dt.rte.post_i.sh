#!/bin/ksh
# @(#)26        1.2  src/packages/X11/loc/fr_CA/Dt/rte/usr/X11.loc.fr_CA.Dt.rte.post_i.sh, pkgxcde, pkg411, 9434B411a 8/24/94 13:45:51
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/fr_CA || exit 1

#!/bin/ksh
# @(#)13        1.1  src/packages/X11/loc/cs_CZ/Dt/rte/usr/X11.loc.cs_CZ.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9433B411a 8/11/94 16:26:20
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/cs_CZ/*

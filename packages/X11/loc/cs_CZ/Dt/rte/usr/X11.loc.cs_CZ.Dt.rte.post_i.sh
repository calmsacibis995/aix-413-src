#!/bin/ksh
# @(#)12        1.2  src/packages/X11/loc/cs_CZ/Dt/rte/usr/X11.loc.cs_CZ.Dt.rte.post_i.sh, pkgxcde, pkg411, 9434B411a 8/24/94 13:45:16
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/cs_CZ || exit 1

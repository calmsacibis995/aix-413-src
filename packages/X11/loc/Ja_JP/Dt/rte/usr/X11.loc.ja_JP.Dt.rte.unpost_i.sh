#!/bin/ksh
# @(#)10        1.1  src/packages/X11/loc/ja_JP/Dt/rte/usr/X11.loc.ja_JP.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9432A411a 8/4/94 20:18:47
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/ja_JP/*

#!/bin/ksh
# @(#)10        1.2  src/packages/X11/loc/bg_BG/Dt/rte/usr/X11.loc.bg_BG.Dt.rte.post_i.sh, pkgxcde, pkg411, 9434B411a 8/24/94 13:45:10
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/bg_BG || exit 1

#!/bin/ksh
# @(#)11        1.1  src/packages/X11/loc/bg_BG/Dt/rte/usr/X11.loc.bg_BG.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9433B411a 8/11/94 16:26:16
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/bg_BG/*

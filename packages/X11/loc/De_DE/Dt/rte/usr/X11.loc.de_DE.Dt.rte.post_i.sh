#!/bin/ksh
# @(#)01        1.1  src/packages/X11/loc/de_DE/Dt/rte/usr/X11.loc.de_DE.Dt.rte.post_i.sh, pkgxcde, pkg411, 9432A411a 8/4/94 20:17:10
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/de_DE || exit 1

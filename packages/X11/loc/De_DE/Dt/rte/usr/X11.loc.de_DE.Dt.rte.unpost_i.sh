#!/bin/ksh
# @(#)02        1.1  src/packages/X11/loc/de_DE/Dt/rte/usr/X11.loc.de_DE.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9432A411a 8/4/94 20:17:12
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/de_DE/*

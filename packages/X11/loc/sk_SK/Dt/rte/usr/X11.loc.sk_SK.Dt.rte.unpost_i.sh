#!/bin/ksh
# @(#)55        1.1  src/packages/X11/loc/sk_SK/Dt/rte/usr/X11.loc.sk_SK.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9433B411a 8/11/94 16:29:16
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/sk_SK/*

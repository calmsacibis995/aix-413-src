#!/bin/ksh
# @(#)54        1.2  src/packages/X11/loc/sk_SK/Dt/rte/usr/X11.loc.sk_SK.Dt.rte.post_i.sh, pkgxcde, pkg411, 9434B411a 8/24/94 13:47:05
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/sk_SK || exit 1

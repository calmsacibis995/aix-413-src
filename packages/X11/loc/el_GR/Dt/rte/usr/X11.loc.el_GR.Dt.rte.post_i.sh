#!/bin/ksh
# @(#)18        1.2  src/packages/X11/loc/el_GR/Dt/rte/usr/X11.loc.el_GR.Dt.rte.post_i.sh, pkgxcde, pkg411, 9434B411a 8/24/94 13:45:30
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/el_GR || exit 1

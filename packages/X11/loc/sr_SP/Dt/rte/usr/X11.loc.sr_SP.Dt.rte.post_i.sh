#!/bin/ksh
# @(#)58        1.2  src/packages/X11/loc/sr_SP/Dt/rte/usr/X11.loc.sr_SP.Dt.rte.post_i.sh, pkgxcde, pkg411, 9434B411a 8/24/94 13:47:16
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/sr_SP || exit 1

#!/bin/ksh
# @(#)15        1.1  src/packages/X11/loc/da_DK/Dt/rte/usr/X11.loc.da_DK.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9433B411a 8/11/94 16:26:24
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/da_DK/*

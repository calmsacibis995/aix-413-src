#!/bin/ksh
# @(#)14        1.2  src/packages/X11/loc/da_DK/Dt/rte/usr/X11.loc.da_DK.Dt.rte.post_i.sh, pkgxcde, pkg411, 9434B411a 8/24/94 13:45:21
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/da_DK || exit 1

#!/bin/ksh
# @(#)23        1.1  src/packages/X11/loc/fi_FI/Dt/rte/usr/X11.loc.fi_FI.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9433B411a 8/11/94 16:27:19
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/fi_FI/*

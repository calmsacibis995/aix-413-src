#!/bin/ksh
# @(#)07        1.1  src/packages/X11/loc/it_IT/Dt/rte/usr/X11.loc.it_IT.Dt.rte.post_i.sh, pkgxcde, pkg411, 9432A411a 8/4/94 20:18:41
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/it_IT || exit 1

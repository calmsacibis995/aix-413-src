#!/bin/ksh
# @(#)08        1.1  src/packages/X11/loc/it_IT/Dt/rte/usr/X11.loc.it_IT.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9432A411a 8/4/94 20:18:43
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/it_IT/*

#!/bin/ksh
# @(#)34        1.2  src/packages/X11/loc/is_IS/Dt/rte/usr/X11.loc.is_IS.Dt.rte.post_i.sh, pkgxcde, pkg411, 9434B411a 8/24/94 13:46:11
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/is_IS || exit 1

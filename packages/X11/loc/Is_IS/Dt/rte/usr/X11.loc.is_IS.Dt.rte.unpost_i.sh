#!/bin/ksh
# @(#)35        1.1  src/packages/X11/loc/is_IS/Dt/rte/usr/X11.loc.is_IS.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9433B411a 8/11/94 16:28:09
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/is_IS/*

#!/bin/ksh
# @(#)19        1.1  src/packages/X11/loc/zh_TW/Dt/rte/usr/X11.loc.zh_TW.Dt.rte.post_i.sh, pkgxcde, pkg411, 9432A411a 8/4/94 20:19:07
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/zh_TW || exit 1

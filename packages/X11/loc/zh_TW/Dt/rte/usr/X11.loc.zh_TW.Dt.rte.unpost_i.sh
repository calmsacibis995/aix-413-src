#!/bin/ksh
# @(#)20        1.1  src/packages/X11/loc/zh_TW/Dt/rte/usr/X11.loc.zh_TW.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9432A411a 8/4/94 20:19:09
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/zh_TW/*

#!/bin/ksh
# @(#)41        1.1  src/packages/X11/loc/nl_NL/Dt/rte/usr/X11.loc.nl_NL.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9433B411a 8/11/94 16:28:36
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/nl_NL/*

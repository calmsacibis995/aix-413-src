#!/bin/ksh
# @(#)40        1.2  src/packages/X11/loc/nl_NL/Dt/rte/usr/X11.loc.nl_NL.Dt.rte.post_i.sh, pkgxcde, pkg411, 9434B411a 8/24/94 13:46:28
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/nl_NL || exit 1

#!/bin/ksh
# @(#)04        1.1  src/packages/X11/loc/es_ES/Dt/rte/usr/X11.loc.es_ES.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9432A411a 8/4/94 20:18:34
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/es_ES/*

#!/bin/ksh
# @(#)03        1.1  src/packages/X11/loc/es_ES/Dt/rte/usr/X11.loc.es_ES.Dt.rte.post_i.sh, pkgxcde, pkg411, 9432A411a 8/4/94 20:18:16
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/es_ES || exit 1

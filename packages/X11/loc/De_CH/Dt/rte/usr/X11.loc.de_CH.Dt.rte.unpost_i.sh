#!/bin/ksh
# @(#)17        1.1  src/packages/X11/loc/de_CH/Dt/rte/usr/X11.loc.de_CH.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9433B411a 8/11/94 16:26:28
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/de_CH/*

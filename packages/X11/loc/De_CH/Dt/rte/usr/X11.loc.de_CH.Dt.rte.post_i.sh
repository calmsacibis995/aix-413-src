#!/bin/ksh
# @(#)16        1.2  src/packages/X11/loc/de_CH/Dt/rte/usr/X11.loc.de_CH.Dt.rte.post_i.sh, pkgxcde, pkg411, 9434B411a 8/24/94 13:45:25
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/de_CH || exit 1

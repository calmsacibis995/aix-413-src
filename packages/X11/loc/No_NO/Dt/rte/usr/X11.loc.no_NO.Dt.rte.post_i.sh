#!/bin/ksh
# @(#)15        1.1  src/packages/X11/loc/no_NO/Dt/rte/usr/X11.loc.no_NO.Dt.rte.post_i.sh, pkgxcde, pkg411, 9432A411a 8/4/94 20:18:58
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/no_NO || exit 1

#!/bin/ksh
# @(#)50        1.2  src/packages/X11/loc/ru_RU/Dt/rte/usr/X11.loc.ru_RU.Dt.rte.post_i.sh, pkgxcde, pkg411, 9434B411a 8/24/94 13:46:56
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/ru_RU || exit 1

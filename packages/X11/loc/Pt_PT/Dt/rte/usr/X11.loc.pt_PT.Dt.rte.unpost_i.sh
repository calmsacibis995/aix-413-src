#!/bin/ksh
# @(#)47        1.1  src/packages/X11/loc/pt_PT/Dt/rte/usr/X11.loc.pt_PT.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9433B411a 8/11/94 16:29:00
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/pt_PT/*

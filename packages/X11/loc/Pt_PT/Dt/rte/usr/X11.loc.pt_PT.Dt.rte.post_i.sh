#!/bin/ksh
# @(#)46        1.2  src/packages/X11/loc/pt_PT/Dt/rte/usr/X11.loc.pt_PT.Dt.rte.post_i.sh, pkgxcde, pkg411, 9434B411a 8/24/94 13:46:46
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/pt_PT || exit 1

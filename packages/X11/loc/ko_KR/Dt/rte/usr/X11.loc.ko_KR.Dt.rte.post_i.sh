#!/bin/ksh
# @(#)11        1.1  src/packages/X11/loc/ko_KR/Dt/rte/usr/X11.loc.ko_KR.Dt.rte.post_i.sh, pkgxcde, pkg411, 9432A411a 8/4/94 20:18:49
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/ko_KR || exit 1

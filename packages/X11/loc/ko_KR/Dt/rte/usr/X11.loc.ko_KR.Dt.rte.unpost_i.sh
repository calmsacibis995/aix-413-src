#!/bin/ksh
# @(#)12        1.1  src/packages/X11/loc/ko_KR/Dt/rte/usr/X11.loc.ko_KR.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9432A411a 8/4/94 20:18:51
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/ko_KR/*

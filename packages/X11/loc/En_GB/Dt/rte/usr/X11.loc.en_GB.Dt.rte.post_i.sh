#!/bin/ksh
# @(#)20        1.2  src/packages/X11/loc/en_GB/Dt/rte/usr/X11.loc.en_GB.Dt.rte.post_i.sh, pkgxcde, pkg411, 9434B411a 8/24/94 13:45:35
#
...
# ------------------------------------------------------------------------
cd /usr/dt/appconfig/types/en_GB || exit 1

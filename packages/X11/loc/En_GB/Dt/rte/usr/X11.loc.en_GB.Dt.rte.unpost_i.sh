#!/bin/ksh
# @(#)21        1.1  src/packages/X11/loc/en_GB/Dt/rte/usr/X11.loc.en_GB.Dt.rte.unpost_i.sh, pkgxcde, pkg411, 9433B411a 8/11/94 16:27:11
#
...
# ------------------------------------------------------------------------
/usr/bin/rm -rf /usr/dt/appconfig/appmanager/en_GB/*

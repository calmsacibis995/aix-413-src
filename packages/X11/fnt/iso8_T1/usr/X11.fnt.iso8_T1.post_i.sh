#!/bin/ksh
#  @(#)95        1.4  src/packages/X11/fnt/iso8_T1/usr/X11.fnt.iso8_T1.post_i.sh, pkgx, pkg411, GOLD410 3/16/94 11:11:07
#
#   COMPONENT_NAME: pkgx
#
#   FUNCTIONS: X11.fnt.iso8_T1 (usr) post installation configuration
#
#   ORIGINS: 27
#
#
...
awk '{
     ...
     }' $FONTDIR/fonts.scale $FONTDIR/fonts.scale.iso8 > $FONTDIR/fonts.new

#!/bin/ksh
#  @(#)64        1.4  src/packages/X11/fnt/iso8_T1/usr/X11.fnt.iso8_T1.unpost_i.sh, pkgx, pkg411, GOLD410 5/11/94 08:58:27
#
#   COMPONENT_NAME: pkgx
#
#   FUNCTIONS: X11.fnt.iso8_T1 (usr) unpost installation configuration
#
#   ORIGINS: 27
#
#
...
if [ -f $FONTDIR/fonts.scale ]; then
  grep -vxf $FONTDIR/fonts.scale.iso8 $FONTDIR/fonts.scale > $FONTDIR/fonts.scale.new || exit 1

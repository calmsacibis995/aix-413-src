#!/bin/ksh
#  @(#)96        1.5  src/packages/X11/fnt/iso8_T1/usr/X11.fnt.iso8_T1.unpre_i.sh, pkgx, pkg411, GOLD410 4/6/94 18:04:37
#
#   COMPONENT_NAME: pkgx
#
#   FUNCTIONS: X11.fnt.iso8_T1 (usr) unpre installation configuration
#
#   ORIGINS: 27
#
#

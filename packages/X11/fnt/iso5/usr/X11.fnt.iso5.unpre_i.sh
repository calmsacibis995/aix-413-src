#!/bin/ksh
#  @(#)77        1.6  src/packages/X11/fnt/iso5/usr/X11.fnt.iso5.unpre_i.sh, pkgx, pkg411, GOLD410 4/6/94 18:02:14
#
#   COMPONENT_NAME: pkgx
#
#   FUNCTIONS: X11.fnt.iso5 (usr) unpre installation configuration
#
#   ORIGINS: 27
#
#

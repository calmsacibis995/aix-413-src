#!/bin/ksh
#  @(#)83        1.6  src/packages/X11/fnt/iso9/usr/X11.fnt.iso9.unpre_i.sh, pkgx, pkg411, GOLD410 4/6/94 18:05:24
#
#   COMPONENT_NAME: pkgx
#
#   FUNCTIONS: X11.fnt.iso9 (usr) unpre installation configuration
#
#   ORIGINS: 27
#
#

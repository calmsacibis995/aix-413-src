#!/bin/ksh
#  @(#)94        1.5  src/packages/X11/fnt/ibm1046_T1/usr/X11.fnt.ibm1046_T1.unpre_i.sh, pkgx, pkg411, GOLD410 4/6/94 17:57:16
#
#   COMPONENT_NAME: pkgx
#
#   FUNCTIONS: X11.fnt.ibm1046_T1 (usr) unpre installation configuration
#
#   ORIGINS: 27
#
#

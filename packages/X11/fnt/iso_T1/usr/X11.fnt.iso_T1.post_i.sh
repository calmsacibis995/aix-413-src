#!/bin/ksh
#  @(#)97        1.4  src/packages/X11/fnt/iso_T1/usr/X11.fnt.iso_T1.post_i.sh, pkgx, pkg411, GOLD410 3/16/94 10:54:42
#
#   COMPONENT_NAME: pkgx
#
#   FUNCTIONS: X11.fnt.iso_T1 (usr) post installation configuration
#
#   ORIGINS: 27
#
#
...
awk '{
     ...
     }' $FONTDIR/fonts.scale $FONTDIR/fonts.scale.lat > $FONTDIR/fonts.new

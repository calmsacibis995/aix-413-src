#!/bin/ksh
#  @(#)68        1.5  src/packages/X11/fnt/ibm1046/usr/X11.fnt.ibm1046.post_i.sh, pkgx, pkg411, GOLD410 3/8/94 15:39:14
#
#   COMPONENT_NAME: pkgx
#
#   FUNCTIONS: X11.fnt.ibm1046 (usr) post installation configuration
#
#   ORIGINS: 27
#
#

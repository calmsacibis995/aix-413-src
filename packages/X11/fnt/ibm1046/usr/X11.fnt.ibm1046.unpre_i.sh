#!/bin/ksh
#  @(#)69        1.7  src/packages/X11/fnt/ibm1046/usr/X11.fnt.ibm1046.unpre_i.sh, pkgx, pkg411, GOLD410 4/6/94 17:56:32
#
#   COMPONENT_NAME: pkgx
#
#   FUNCTIONS: X11.fnt.ibm1046 (usr) unpre installation configuration
#
#   ORIGINS: 27
#
#

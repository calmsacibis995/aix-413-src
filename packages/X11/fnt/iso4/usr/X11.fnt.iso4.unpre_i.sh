#!/bin/ksh
#  @(#)75        1.6  src/packages/X11/fnt/iso4/usr/X11.fnt.iso4.unpre_i.sh, pkgx, pkg411, GOLD410 4/6/94 18:01:28
#
#   COMPONENT_NAME: pkgx
#
#   FUNCTIONS: X11.fnt.iso4 (usr) unpre installation configuration
#
#   ORIGINS: 27
#
#

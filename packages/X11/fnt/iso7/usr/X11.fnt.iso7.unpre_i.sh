#!/bin/ksh
#  @(#)79        1.6  src/packages/X11/fnt/iso7/usr/X11.fnt.iso7.unpre_i.sh, pkgx, pkg411, GOLD410 4/6/94 18:03:22
#
#   COMPONENT_NAME: pkgx
#
#   FUNCTIONS: X11.fnt.iso7 (usr) unpre installation configuration
#
#   ORIGINS: 27
#
#

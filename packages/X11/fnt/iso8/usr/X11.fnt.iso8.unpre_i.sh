#!/bin/ksh
#  @(#)81        1.6  src/packages/X11/fnt/iso8/usr/X11.fnt.iso8.unpre_i.sh, pkgx, pkg411, GOLD410 4/6/94 18:03:58
#
#   COMPONENT_NAME: pkgx
#
#   FUNCTIONS: X11.fnt.iso8 (usr) unpre installation configuration
#
#   ORIGINS: 27
#
#

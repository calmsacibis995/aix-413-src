#!/bin/ksh
#  @(#)92        1.4  src/packages/X11/fnt/Gr_Cyr_T1/usr/X11.fnt.Gr_Cyr_T1.unpre_i.sh, pkgx, pkg411, GOLD410 4/6/94 17:41:54
#
#   COMPONENT_NAME: pkgx
#
#   FUNCTIONS: X11.fnt.Gr_Cyr_T1 (usr) unpre installation configuration
#
#   ORIGINS: 27
#
#

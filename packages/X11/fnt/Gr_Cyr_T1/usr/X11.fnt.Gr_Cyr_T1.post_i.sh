#!/bin/ksh
#  @(#)91        1.3  src/packages/X11/fnt/Gr_Cyr_T1/usr/X11.fnt.Gr_Cyr_T1.post_i.sh, pkgx, pkg411, GOLD410 3/16/94 11:08:14
#
#   COMPONENT_NAME: pkgx
#
#   FUNCTIONS: X11.fnt.Gr_Cyr_T1 (usr) post installation configuration
#
#   ORIGINS: 27
#
#
...
awk '{
     ...
     }' $FONTDIR/fonts.scale $FONTDIR/fonts.scale.CG > $FONTDIR/fonts.new

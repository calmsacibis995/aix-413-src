#!/bin/ksh
#  @(#)71        1.7  src/packages/X11/fnt/iso2/usr/X11.fnt.iso2.unpre_i.sh, pkgx, pkg411, GOLD410 4/6/94 18:00:18
#
#   COMPONENT_NAME: pkgx
#
#   FUNCTIONS: X11.fnt.iso2 (usr) unpre installation configuration
#
#   ORIGINS: 27
#
#

#!/usr/bin/ksh
# @(#)06	1.1  src/packages/printers/bull924N/rte/usr/printers.bull924N.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:03:08
#
...
#
typeset -r	uniquetypes="printer/parallel/bull924N printer/rs232/bull924N printer/rs422/bull924N"
typeset -r	ptype="bull924N"
typeset		type

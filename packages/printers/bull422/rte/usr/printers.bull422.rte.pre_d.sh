#!/usr/bin/ksh
# @(#)54	1.1  src/packages/printers/bull422/rte/usr/printers.bull422.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 17:57:27
#
...
#
typeset -r	uniquetypes="printer/parallel/bull422 printer/rs232/bull422 printer/rs422/bull422"
typeset -r	ptype="bull422"
typeset		type

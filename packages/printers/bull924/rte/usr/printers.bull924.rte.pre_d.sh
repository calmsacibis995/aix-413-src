#!/usr/bin/ksh
# @(#)98	1.1  src/packages/printers/bull924/rte/usr/printers.bull924.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:02:21
#
...
#
typeset -r	uniquetypes="printer/parallel/bull924 printer/rs232/bull924 printer/rs422/bull924"
typeset -r	ptype="bull924"
typeset		type

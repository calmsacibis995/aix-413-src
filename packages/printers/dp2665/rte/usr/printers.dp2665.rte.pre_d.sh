#!/usr/bin/ksh
# @(#)36	1.1  src/packages/printers/dp2665/rte/usr/printers.dp2665.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:32:07
#
...
#
typeset -r	uniquetypes="printer/parallel/dp2665 printer/rs232/dp2665 printer/rs422/dp2665"
typeset -r	ptype="dp2665"
typeset		type

#!/usr/bin/ksh
# @(#)62	1.1  src/packages/printers/bull451/rte/usr/printers.bull451.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 17:58:20
#
...
#
typeset -r	uniquetypes="printer/parallel/bull451 printer/rs232/bull451 printer/rs422/bull451"
typeset -r	ptype="bull451"
typeset		type

#!/usr/bin/ksh
# @(#)35	1.1  src/packages/printers/dp2000/rte/usr/printers.dp2000.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:31:49
#
...
#
typeset -r	uniquetypes="printer/parallel/dp2000"
typeset -r	ptype="dp2000"
typeset		type

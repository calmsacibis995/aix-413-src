#!/usr/bin/ksh
# @(#)25	1.1  src/packages/printers/ibm3816/rte/usr/printers.ibm3816.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:17:00
#
...
#
typeset -r	uniquetypes="printer/rs232/ibm3816 printer/rs422/ibm3816"
typeset -r	ptype="ibm3816"
typeset		type

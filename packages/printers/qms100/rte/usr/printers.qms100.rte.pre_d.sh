#!/usr/bin/ksh
# @(#)42	1.1  src/packages/printers/qms100/rte/usr/printers.qms100.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:34:11
#
...
#
typeset -r	uniquetypes="printer/parallel/qms100 printer/rs232/qms100 printer/rs422/qms100"
typeset -r	ptype="qms100"
typeset		type

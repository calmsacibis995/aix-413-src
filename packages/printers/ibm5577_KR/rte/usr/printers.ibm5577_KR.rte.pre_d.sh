#!/usr/bin/ksh
# @(#)53	1.1  src/packages/printers/ibm5577_KR/rte/usr/printers.ibm5577_KR.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:37:30
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm5577"
typeset -r	ptype="ibm5577"
typeset		type

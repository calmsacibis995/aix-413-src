#!/usr/bin/ksh
# @(#)57	1.1  src/packages/printers/ibm4029_JP/rte/usr/printers.ibm4029_JP.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:38:18
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm4029 printer/rs232/ibm4029"
typeset -r	ptype="ibm4029"
typeset		type

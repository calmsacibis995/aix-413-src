#!/usr/bin/ksh
# @(#)04	1.1  src/packages/printers/ibm2390/rte/usr/printers.ibm2390.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:14:54
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm2390 printer/rs232/ibm2390 printer/rs422/ibm2390"
typeset -r	ptype="ibm2390"
typeset		type

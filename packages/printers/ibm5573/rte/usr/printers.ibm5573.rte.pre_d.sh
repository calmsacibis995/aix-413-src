#!/usr/bin/ksh
# @(#)58	1.1  src/packages/printers/ibm5573/rte/usr/printers.ibm5573.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:38:30
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm5573"
typeset -r	ptype="ibm5573"
typeset		type

#!/usr/bin/ksh
# @(#)39	1.1  src/packages/printers/p9012/rte/usr/printers.p9012.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:33:05
#
...
#
typeset -r	uniquetypes="printer/parallel/p9012 printer/rs232/p9012"
typeset -r	ptype="p9012"
typeset		type

#!/usr/bin/ksh
# @(#)43	1.1  src/packages/printers/ti2115/rte/usr/printers.ti2115.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:34:28
#
...
#
typeset -r	uniquetypes="printer/parallel/ti2115 printer/rs232/ti2115 printer/rs422/ti2115"
typeset -r	ptype="ti2115"
typeset		type

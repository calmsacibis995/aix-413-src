#!/usr/bin/ksh
# @(#)45	1.1  src/packages/printers/ibm2390-2/rte/usr/printers.ibm2390-2.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:34:59
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm2390-2 printer/rs232/ibm2390-2 printer/rs422/ibm2390-2"
typeset -r	ptype="ibm2390-2"
typeset		type

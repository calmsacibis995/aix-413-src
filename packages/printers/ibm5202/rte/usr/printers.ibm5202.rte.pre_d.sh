#!/usr/bin/ksh
# @(#)35	1.1  src/packages/printers/ibm5202/rte/usr/printers.ibm5202.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:25:34
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm5202"
typeset -r	ptype="ibm5202"
typeset		type

#!/usr/bin/ksh
# @(#)38	1.1  src/packages/printers/bull1070/rte/usr/printers.bull1070.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 17:55:24
#
...
#
typeset -r	uniquetypes="printer/parallel/bull1070 printer/rs232/bull1070 printer/rs422/bull1070"
typeset -r	ptype="bull1070"
typeset		type

#!/usr/bin/ksh
# @(#)32        1.1  src/packages/printers/hplj-4+/rte/usr/printers.hplj-4+.rte.pre_d.sh, pkgdevprint, pkg41J, 9512A_all 3/15/95 19:13:59
#
...
#
typeset -r	uniquetypes="printer/parallel/hplj-4+ printer/rs232/hplj-4+ printer/rs422/hplj-4+"
typeset -r	ptype="hplj-4+"
typeset		type

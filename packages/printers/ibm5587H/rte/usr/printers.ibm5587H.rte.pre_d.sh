#!/usr/bin/ksh
# @(#)83	1.1  src/packages/printers/ibm5587H/rte/usr/printers.ibm5587H.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:28:04
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm5587H"
typeset -r	ptype="ibm5587H"
typeset		type

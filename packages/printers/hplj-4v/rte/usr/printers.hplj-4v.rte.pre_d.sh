#!/usr/bin/ksh
# @(#)30        1.1  src/packages/printers/hplj-4v/rte/usr/printers.hplj-4v.rte.pre_d.sh, pkgdevprint, pkg41J, 9512A_all 3/15/95 19:13:55
#
...
#
typeset -r	uniquetypes="printer/parallel/hplj-4v printer/rs232/hplj-4v printer/rs422/hplj-4v"
typeset -r	ptype="hplj-4v"
typeset		type

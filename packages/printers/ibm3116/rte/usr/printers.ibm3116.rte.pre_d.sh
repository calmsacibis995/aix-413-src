#!/usr/bin/ksh
# @(#)92        1.1  src/packages/printers/ibm3116/rte/usr/printers.ibm3116.rte.pre_d.sh, pkgdevprint, pkg41J, 9512A_all 3/15/95 19:15:47
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm3116 printer/rs232/ibm3116 printer/rs422/ibm3116"
typeset -r	ptype="ibm3116"
typeset		type

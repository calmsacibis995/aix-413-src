#!/usr/bin/ksh
# @(#)61	1.1  src/packages/printers/ibm5585_JP/rte/usr/printers.ibm5585_JP.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:39:06
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm5585"
typeset -r	ptype="ibm5585"
typeset		type

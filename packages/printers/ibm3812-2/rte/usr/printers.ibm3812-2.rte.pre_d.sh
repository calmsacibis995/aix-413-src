#!/usr/bin/ksh
# @(#)18	1.1  src/packages/printers/ibm3812-2/rte/usr/printers.ibm3812-2.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:16:10
#
...
#
typeset -r	uniquetypes="printer/rs232/ibm3812-2 printer/rs422/ibm3812-2"
typeset -r	ptype="ibm3812-2"
typeset		type

#!/usr/bin/ksh
# @(#)46	1.1  src/packages/printers/ibm2391-2/rte/usr/printers.ibm2391-2.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:35:22
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm2391-2 printer/rs232/ibm2391-2 printer/rs422/ibm2391-2"
typeset -r	ptype="ibm2391-2"
typeset		type

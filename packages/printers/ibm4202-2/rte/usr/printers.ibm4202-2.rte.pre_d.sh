#!/usr/bin/ksh
# @(#)66	1.1  src/packages/printers/ibm4202-2/rte/usr/printers.ibm4202-2.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:20:35
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm4202-2 printer/rs232/ibm4202-2"
typeset -r	ptype="ibm4202-2"
typeset		type

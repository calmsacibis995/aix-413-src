#!/usr/bin/ksh
# @(#)76	1.1  src/packages/printers/ibm5587/rte/usr/printers.ibm5587.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:27:46
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm5587"
typeset -r	ptype="ibm5587"
typeset		type

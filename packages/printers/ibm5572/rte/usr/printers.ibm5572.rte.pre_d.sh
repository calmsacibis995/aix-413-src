#!/usr/bin/ksh
# @(#)56	1.1  src/packages/printers/ibm5572/rte/usr/printers.ibm5572.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:26:51
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm5572"
typeset -r	ptype="ibm5572"
typeset		type

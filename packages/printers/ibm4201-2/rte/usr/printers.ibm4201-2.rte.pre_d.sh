#!/usr/bin/ksh
# @(#)59	1.1  src/packages/printers/ibm4201-2/rte/usr/printers.ibm4201-2.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:20:03
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm4201-2 printer/rs232/ibm4201-2"
typeset -r	ptype="ibm4201-2"
typeset		type

#!/usr/bin/ksh
# @(#)68	1.1  src/packages/printers/ibm4070/rte/usr/printers.ibm4070.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 17:51:01
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm4070"
typeset -r	ptype="ibm4070"
typeset		type

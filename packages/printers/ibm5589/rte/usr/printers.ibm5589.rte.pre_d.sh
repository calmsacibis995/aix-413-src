#!/usr/bin/ksh
# @(#)90	1.1  src/packages/printers/ibm5589/rte/usr/printers.ibm5589.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:28:22
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm5589"
typeset -r	ptype="ibm5589"
typeset		type

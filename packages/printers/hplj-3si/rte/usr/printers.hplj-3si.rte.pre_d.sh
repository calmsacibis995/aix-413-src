#!/usr/bin/ksh
# @(#)97	1.1  src/packages/printers/hplj-3si/rte/usr/printers.hplj-3si.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 17:52:58
#
...
#
typeset -r	uniquetypes="printer/parallel/hplj-3si printer/rs232/hplj-3si printer/rs422/hplj-3si"
typeset -r	ptype="hplj-3si"
typeset		type

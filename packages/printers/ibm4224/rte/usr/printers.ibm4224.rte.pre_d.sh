#!/usr/bin/ksh
# @(#)12	1.1  src/packages/printers/ibm4224/rte/usr/printers.ibm4224.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:23:50
#
...
#
typeset -r	uniquetypes="printer/rs232/ibm4224 printer/rs422/ibm4224"
typeset -r	ptype="ibm4224"
typeset		type

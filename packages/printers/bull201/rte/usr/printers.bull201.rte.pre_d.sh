#!/usr/bin/ksh
# @(#)27	1.1  src/packages/printers/bull201/rte/usr/printers.bull201.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:05:29
#
...
#
typeset -r	uniquetypes="printer/parallel/bull201 printer/rs232/bull201"
typeset -r	ptype="bull201"
typeset		type

#!/usr/bin/ksh
# @(#)96	1.1  src/packages/printers/ibm6180/rte/usr/printers.ibm6180.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:28:38
#
...
#
typeset -r	uniquetypes="printer/rs232/ibm6180"
typeset -r	ptype="ibm6180"
typeset		type

#!/usr/bin/ksh
# @(#)74	1.1  src/packages/printers/ibm4202-3/rte/usr/printers.ibm4202-3.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:21:09
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm4202-3 printer/rs232/ibm4202-3 printer/rs422/ibm4202-3"
typeset -r	ptype="ibm4202-3"
typeset		type

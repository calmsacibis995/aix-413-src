#!/usr/bin/ksh
# @(#)90	1.1  src/packages/printers/ibm4208-502/rte/usr/printers.ibm4208-502.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:22:20
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm4208-502"
typeset -r	ptype="ibm4208-502"
typeset		type

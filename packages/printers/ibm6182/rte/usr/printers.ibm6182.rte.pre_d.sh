#!/usr/bin/ksh
# @(#)02	1.1  src/packages/printers/ibm6182/rte/usr/printers.ibm6182.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:28:59
#
...
#
typeset -r	uniquetypes="printer/rs232/ibm6182"
typeset -r	ptype="ibm6182"
typeset		type

#!/usr/bin/ksh
# @(#)14	1.1  src/packages/printers/bull970/rte/usr/printers.bull970.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:03:56
#
...
#
typeset -r	uniquetypes="printer/parallel/bull970 printer/rs232/bull970 printer/rs422/bull970"
typeset -r	ptype="bull970"
typeset		type

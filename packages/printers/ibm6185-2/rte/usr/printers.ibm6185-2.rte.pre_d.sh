#!/usr/bin/ksh
# @(#)23	1.1  src/packages/printers/ibm6185-2/rte/usr/printers.ibm6185-2.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:30:21
#
...
#
typeset -r	uniquetypes="printer/rs232/ibm6185-2"
typeset -r	ptype="ibm6185-2"
typeset		type

#!/usr/bin/ksh
# @(#)09	1.1  src/packages/printers/ibm6184/rte/usr/printers.ibm6184.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:29:26
#
...
#
typeset -r	uniquetypes="printer/rs232/ibm6184"
typeset -r	ptype="ibm6184"
typeset		type

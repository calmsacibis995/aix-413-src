#!/usr/bin/ksh
# @(#)59	1.1  src/packages/printers/ibm4079/rte/usr/printers.ibm4079.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 17:50:10
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm4079 printer/rs232/ibm4079"
typeset -r	ptype="ibm4079"
typeset		type

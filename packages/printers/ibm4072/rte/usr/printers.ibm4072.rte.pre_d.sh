#!/usr/bin/ksh
# @(#)50	1.1  src/packages/printers/ibm4072/rte/usr/printers.ibm4072.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:19:20
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm4072 printer/rs232/ibm4072 printer/rs422/ibm4072"
typeset -r	ptype="ibm4072"
typeset		type

#!/usr/bin/ksh
# @(#)78        1.1  src/packages/printers/ibm3112/rte/usr/printers.ibm3112.rte.pre_d.sh, pkgdevprint, pkg41J, 9512A_all 3/15/95 19:15:22
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm3112 printer/rs232/ibm3112 printer/rs422/ibm3112"
typeset -r	ptype="ibm3112"
typeset		type

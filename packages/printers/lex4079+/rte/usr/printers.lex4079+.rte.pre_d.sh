#!/usr/bin/ksh
# @(#)83        1.1  src/packages/printers/lex4079+/rte/usr/printers.lex4079+.rte.pre_d.sh, pkgdevprint, pkg41J, 9512A_all 3/15/95 19:15:31
#
...
#
typeset -r	uniquetypes="printer/parallel/lex4079+ printer/rs232/lex4079+ printer/rs422/lex4079+"
typeset -r	ptype="lex4079+"
typeset		type

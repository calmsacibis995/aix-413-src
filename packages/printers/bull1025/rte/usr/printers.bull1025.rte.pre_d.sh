#!/usr/bin/ksh
# @(#)11 1.1 src/packages/printers/bull1025/rte/usr/printers.bull1025.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 4/28/94 08:25:58
#
...
#
typeset -r	uniquetypes="printer/parallel/bull1025 printer/rs232/bull1025 printer/rs422/bull1025"
typeset -r	ptype="bull1025"
typeset		type

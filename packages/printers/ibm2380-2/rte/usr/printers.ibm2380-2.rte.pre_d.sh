#!/usr/bin/ksh
# @(#)44	1.1  src/packages/printers/ibm2380-2/rte/usr/printers.ibm2380-2.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:34:42
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm2380-2 printer/rs232/ibm2380-2 printer/rs422/ibm2380-2"
typeset -r	ptype="ibm2380-2"
typeset		type

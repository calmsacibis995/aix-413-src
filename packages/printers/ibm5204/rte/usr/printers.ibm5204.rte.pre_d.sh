#!/usr/bin/ksh
# @(#)41	1.1  src/packages/printers/ibm5204/rte/usr/printers.ibm5204.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:26:05
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm5204 printer/rs232/ibm5204"
typeset -r	ptype="ibm5204"
typeset		type

#!/usr/bin/ksh
# @(#)97	1.1  src/packages/printers/ibm4212/rte/usr/printers.ibm4212.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:22:50
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm4212"
typeset -r	ptype="ibm4212"
typeset		type

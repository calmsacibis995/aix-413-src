#!/usr/bin/ksh
# @(#)76	1.1  src/packages/printers/bull721/rte/usr/printers.bull721.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 17:59:53
#
...
#
typeset -r	uniquetypes="printer/parallel/bull721 printer/rs232/bull721 printer/rs422/bull721"
typeset -r	ptype="bull721"
typeset		type

#!/usr/bin/ksh
# @(#)33	1.1  src/packages/printers/ibm7372/rte/usr/printers.ibm7372.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:31:06
#
...
#
typeset -r	uniquetypes="printer/rs232/ibm7372"
typeset -r	ptype="ibm7372"
typeset		type

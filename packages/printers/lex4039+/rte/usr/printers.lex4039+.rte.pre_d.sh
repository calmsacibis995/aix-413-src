#!/usr/bin/ksh
# @(#)56        1.1  src/packages/printers/lex4039+/rte/usr/printers.lex4039+.rte.pre_d.sh, pkgdevprint, pkg41J, 9512A_all 3/15/95 19:14:42
#
...
#
typeset -r	uniquetypes="printer/parallel/lex4039+ printer/rs232/lex4039+ printer/rs422/lex4039+"
typeset -r	ptype="lex4039+"
typeset		type

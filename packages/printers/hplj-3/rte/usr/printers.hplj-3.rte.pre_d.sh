#!/usr/bin/ksh
# @(#)13	1.1  src/packages/printers/hplj-3/rte/usr/printers.hplj-3.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 17:53:41
#
...
#
typeset -r	uniquetypes="printer/parallel/hplj-3 printer/rs232/hplj-3 printer/rs422/hplj-3"
typeset -r	ptype="hplj-3"
typeset		type

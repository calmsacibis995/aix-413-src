#!/usr/bin/ksh
# @(#)05	1.1  src/packages/printers/ibm4216-510/rte/usr/printers.ibm4216-510.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:23:21
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm4216-510"
typeset -r	ptype="ibm4216-510"
typeset		type

#!/usr/bin/ksh
# @(#)49	1.1  src/packages/printers/ibm5327/rte/usr/printers.ibm5327.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:26:29
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm5327"
typeset -r	ptype="ibm5327"
typeset		type

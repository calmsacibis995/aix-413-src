#!/usr/bin/ksh
# @(#)51	1.1  src/packages/printers/ibm5575_TW/rte/usr/printers.ibm5575_TW.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:36:58
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm5575"
typeset -r	ptype="ibm5575"
typeset		type

#!/usr/bin/ksh
# @(#)59	1.1  src/packages/printers/ibm5584/rte/usr/printers.ibm5584.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:38:42
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm5584"
typeset -r	ptype="ibm5584"
typeset		type

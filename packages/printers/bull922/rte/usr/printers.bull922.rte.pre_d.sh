#!/usr/bin/ksh
# @(#)83	1.1  src/packages/printers/bull922/rte/usr/printers.bull922.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:00:48
#
...
#
typeset -r	uniquetypes="printer/parallel/bull922 printer/rs232/bull922 printer/rs422/bull922"
typeset -r	ptype="bull922"
typeset		type

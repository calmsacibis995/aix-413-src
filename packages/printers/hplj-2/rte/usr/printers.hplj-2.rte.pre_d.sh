#!/usr/bin/ksh
# @(#)37	1.1  src/packages/printers/hplj-2/rte/usr/printers.hplj-2.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:32:26
#
...
#
typeset -r	uniquetypes="printer/parallel/hplj-2 printer/rs232/hplj-2 printer/rs422/hplj-2"
typeset -r	ptype="hplj-2"
typeset		type

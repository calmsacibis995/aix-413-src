#!/usr/bin/ksh
# @(#)36	1.1  src/packages/printers/ibm6252/rte/usr/printers.ibm6252.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 17:47:53
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm6252 printer/rs232/ibm6252 printer/rs422/ibm6252"
typeset -r	ptype="ibm6252"
typeset		type

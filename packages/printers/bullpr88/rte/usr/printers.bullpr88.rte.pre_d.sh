#!/usr/bin/ksh
# @(#)21	1.1  src/packages/printers/bullpr88/rte/usr/printers.bullpr88.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:04:35
#
...
#
typeset -r	uniquetypes="printer/parallel/bullpr88 printer/rs232/bullpr88"
typeset -r	ptype="bullpr88"
typeset		type

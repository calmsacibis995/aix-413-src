#!/usr/bin/ksh
# @(#)35	1.1  src/packages/printers/ibm4201-3/rte/usr/printers.ibm4201-3.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:06:26
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm4201-3 printer/rs232/ibm4201-3 printer/rs422/ibm4201-3"
typeset -r	ptype="ibm4201-3"
typeset		type

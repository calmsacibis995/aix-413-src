#!/usr/bin/ksh
# @(#)64        1.1  src/packages/printers/lex4049/rte/usr/printers.lex4049.rte.pre_d.sh, pkgdevprint, pkg41J, 9512A_all 3/15/95 19:14:56
#
...
#
typeset -r	uniquetypes="printer/parallel/lex4049 printer/rs232/lex4049 printer/rs422/lex4049"
typeset -r	ptype="lex4049"
typeset		type

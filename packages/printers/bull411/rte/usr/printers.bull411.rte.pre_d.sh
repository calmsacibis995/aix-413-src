#!/usr/bin/ksh
# @(#)46	1.1  src/packages/printers/bull411/rte/usr/printers.bull411.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 17:56:26
#
...
#
typeset -r	uniquetypes="printer/parallel/bull411 printer/rs232/bull411 printer/rs422/bull411"
typeset -r	ptype="bull411"
typeset		type

#!/usr/bin/ksh
# @(#)38	1.1  src/packages/printers/oki801ps/rte/usr/printers.oki801ps.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:32:47
#
...
#
typeset -r	uniquetypes="printer/rs232/oki801ps"
typeset -r	ptype="oki801ps"
typeset		type

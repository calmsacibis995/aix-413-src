#!/usr/bin/ksh
# @(#)16	1.1  src/packages/printers/ibm6185-1/rte/usr/printers.ibm6185-1.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:29:55
#
...
#
typeset -r	uniquetypes="printer/rs232/ibm6185-1"
typeset -r	ptype="ibm6185-1"
typeset		type

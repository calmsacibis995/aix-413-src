#!/usr/bin/ksh
# @(#)81	1.1  src/packages/printers/ibm4207-2/rte/usr/printers.ibm4207-2.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:21:43
#
...
#
typeset -r	uniquetypes="printer/parallel/ibm4207-2 printer/rs232/ibm4207-2 printer/rs422/ibm4207-2"
typeset -r	ptype="ibm4207-2"
typeset		type

#!/usr/bin/ksh
# @(#)90	1.1  src/packages/printers/bull923/rte/usr/printers.bull923.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:01:35
#
...
#
typeset -r	uniquetypes="printer/parallel/bull923 printer/rs232/bull923 printer/rs422/bull923"
typeset -r	ptype="bull923"
typeset		type

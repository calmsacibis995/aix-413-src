#!/usr/bin/ksh
# @(#)61 1.1 src/packages/printers/bull825/rte/usr/printers.bull825.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 4/28/94 08:39:36
#
...
#
typeset -r	uniquetypes="printer/parallel/bull825 printer/rs232/bull825 printer/rs422/bull825"
typeset -r	ptype="bull825"
typeset		type

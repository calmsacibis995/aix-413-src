#!/usr/bin/ksh
# @(#)34	1.1  src/packages/printers/canlbp/rte/usr/printers.canlbp.rte.pre_d.sh, pkgdevprint, pkg411, GOLD410 2/23/94 18:31:26
#
...
#
typeset -r	uniquetypes="printer/parallel/canlbp"
typeset -r	ptype="canlbp"
typeset		type

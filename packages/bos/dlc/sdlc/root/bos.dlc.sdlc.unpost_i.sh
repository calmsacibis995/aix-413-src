#!/bin/bsh
# @(#)81  1.1  src/packages/bos/dlc/sdlc/root/bos.dlc.sdlc.unpost_i.sh, pkgdlc, pkg41J, 9517B_all 4/21/95 13:21:11
#
...
then
	...
	errupdate -qpf $BASE_DIR/sdl.err.undo 1>/dev/null 2>&1

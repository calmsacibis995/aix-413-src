#!/bin/bsh
# static char sccsid[] = "@(#)44  1.2  src/packages/bos/dlc/sdlc/root/bos.dlc.sdlc.post_i.sh, pkgdlc, pkg41J, 9517B_all 4/21/95 13:22:24";
#
...
errupdate -fpq /usr/lpp/bos.dlc/sdlc/sdl.err 1>/dev/null 2>&1
...
errupdate -fpy altmpltfile /usr/lpp/bos.dlc/sdlc/sdl.err 1>/dev/null
 2>&1

#!/bin/bsh
# @(#)83  1.1  src/packages/bos/dlc/sdlc/root/bos.dlc.sdlc.unpost_u.sh, pkgdlc, pkg41J, 9517B_all 4/21/95 13:21:31
#
...
then
	...
	errupdate -qpf $SAVEDIR/sdl.err.undo 1>/dev/null 2>&1

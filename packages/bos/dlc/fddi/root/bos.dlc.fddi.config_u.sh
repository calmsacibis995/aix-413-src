#!/bin/bsh
# static char sccsid[] = "@(#)91  1.2  src/packages/bos/dlc/fddi/root/bos.dlc.fddi.config_u.sh, pkgdlc, pkg411, GOLD410 4/18/94 14:33:54";
#
...
then
	...
	then
		rmdev -l dlcfddi > /dev/null 2>/dev/null

#!/bin/bsh
# static char sccsid[] = "@(#)06  1.3  src/packages/bos/dlc/token/root/bos.dlc.token.unconfig.sh, pkgdlc, pkg411, GOLD410 4/18/94 17:59:14";
#
...
#
#   NAME: bos.dlc.token.unconfig.sh
#
...
then
#	remove the dlc
	rmdev -l dlctoken -d > /dev/null 2>/dev/null
fi

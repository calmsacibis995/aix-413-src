#!/usr/bin/ksh
# @(#)04        1.1  src/packages/bos/powermgt/rte/root/bos.powermgt.rte.config_u.sh, pkgpwrmgt, pkg41J, 9523C_all 6/9/95 14:47:56
# COMPONENT_NAME: pkgpwrmgt
#
# FUNCTIONS: config_u.sh
#
# ORIGINS: 27
#
...
#
# NAME:	 bos.powermgt.rte.config_u.sh
#
# FUNCTION: script called from update to add PM daemon to /etc/inittab.
#

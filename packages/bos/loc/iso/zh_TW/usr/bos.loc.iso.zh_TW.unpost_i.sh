#!/bin/bsh
# @(#)86	1.2  src/packages/bos/loc/iso/zh_TW/usr/bos.loc.iso.zh_TW.unpost_i.sh, pkglociso, pkg411, GOLD410 3/6/94 23:25:19
#
...
then
   grep -vxf $FONTDIR/fonts.alias.TW $FONTDIR/fonts.alias > $FONTDIR/fonts.new$$ || [ $$? -lt 2 ] || exit 1

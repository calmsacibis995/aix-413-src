#!/bin/bsh
# @(#)84	1.2  src/packages/bos/loc/iso/zh_TW/usr/bos.loc.iso.zh_TW.post_i.sh, pkglociso, pkg411, GOLD410 3/6/94 23:25:17
#
...
cat $FONTDIR/fonts.alias.TW >> $FONTDIR/fonts.alias || exit 1

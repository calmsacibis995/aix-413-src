#!/usr/bin/ksh
# SCCS_ID = "@(#)32	1.1  src/packages/bos/rte/im/usr/bos.rte.im.pre_u.sh, pkgbossub, pkg41J, 9521B_all  5/25/95  08:10:01"
#---------------------------------------------------------------------
# ORIGINS: 27
#
...
#  have been fixed
#-------------------------------------------------------------
needsFix=$(${ODMGET} -q "file_type=0 and loc0=/usr/lib/libIM.a" inventory 2>/dev/null)
...
/usr/lib/libIM.a /usr/ccs/lib/libIM.a
EOD

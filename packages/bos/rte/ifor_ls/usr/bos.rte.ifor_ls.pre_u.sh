#!/usr/bin/ksh
# SCCS_ID = "@(#)31	1.1  src/packages/bos/rte/ifor_ls/usr/bos.rte.ifor_ls.pre_u.sh, pkgbossub, pkg41J, 9521B_all  5/25/95  08:09:59"
#---------------------------------------------------------------------
# ORIGINS: 27
#
...
#  have been fixed
#-------------------------------------------------------------
needsFix=$(${ODMGET} -q "file_type=0 and loc0=/usr/lib/libnetls_shr.a" inventory 2>/dev/null)
...
/usr/lib/libshrnck.a /usr/lib/ncs/lib/libshrnck.a
/usr/lib/libnetls_shr.a /usr/lib/netls/adk/lib/libnetls_shr.a
EOD

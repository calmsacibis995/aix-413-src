#!/usr/bin/ksh
# SCCS_ID = "@(#)35	1.1  src/packages/bos/rte/libdbm/usr/bos.rte.libdbm.pre_u.sh, pkgbossub, pkg41J, 9521B_all  5/25/95  08:10:06"
#---------------------------------------------------------------------
# ORIGINS: 27
#
...
#  have been fixed
#-------------------------------------------------------------
needsFix=$(${ODMGET} -q "file_type=0 and loc0=/usr/lib/libdbm.a" inventory 2>/dev/null)
...
/usr/lib/libdbm.a /usr/ccs/lib/libdbm.a
EOD

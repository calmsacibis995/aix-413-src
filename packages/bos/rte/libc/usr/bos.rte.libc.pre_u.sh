#!/usr/bin/ksh
# SCCS_ID = "@(#)33	1.1  src/packages/bos/rte/libc/usr/bos.rte.libc.pre_u.sh, pkgbossub, pkg41J, 9521B_all  5/25/95  08:10:03"
#---------------------------------------------------------------------
# ORIGINS: 27
#
...
#  have been fixed
#-------------------------------------------------------------
needsFix=$(${ODMGET} -q "file_type=0 and loc0=/usr/lib/crt0.o" inventory 2>/dev/null)
...
/usr/lib/threads/libc.a /usr/ccs/lib/libc_r.a
/usr/lib/libc_t.a /usr/ccs/lib/libc.a
/usr/lib/libc_r.a /usr/ccs/lib/libc_r.a
/usr/lib/libc.a /usr/ccs/lib/libc.a
/usr/lib/crt0.o /usr/ccs/lib/crt0.o
EOD

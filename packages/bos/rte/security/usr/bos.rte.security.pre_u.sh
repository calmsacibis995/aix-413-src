#!/usr/bin/ksh
# SCCS_ID = "@(#)41	1.1  src/packages/bos/rte/security/usr/bos.rte.security.pre_u.sh, pkgbossub, pkg41J, 9521B_all  5/25/95  08:10:16"
#---------------------------------------------------------------------
# ORIGINS: 27
#
...
#  have been fixed
#-------------------------------------------------------------
needsFix=$(${ODMGET} -q "file_type=0 and loc0=/usr/bin/login" inventory 2>/dev/null)

#!/usr/bin/ksh
# SCCS_ID = "@(#)36	1.1  src/packages/bos/rte/libpthreads/usr/bos.rte.libpthreads.pre_u.sh, pkgbossub, pkg41J, 9521B_all  5/25/95  08:10:08"
#---------------------------------------------------------------------
# ORIGINS: 27
#
...
#  have been fixed
#-------------------------------------------------------------
needsFix=$(${ODMGET} -q "file_type=0 and loc0=/usr/lib/libpthreads.a" inventory 2>/dev/null)
...
/usr/lib/libpthreads.a /usr/ccs/lib/libpthreads.a
EOD

#!/usr/bin/ksh
# SCCS_ID = "@(#)34	1.1  src/packages/bos/rte/libcur/usr/bos.rte.libcur.pre_u.sh, pkgbossub, pkg41J, 9521B_all  5/25/95  08:10:04"
#---------------------------------------------------------------------
# ORIGINS: 27
#
...
#  have been fixed
#-------------------------------------------------------------
needsFix=$(${ODMGET} -q "file_type=0 and loc0=/usr/ccs/lib/libcurses.a" inventory 2>/dev/null)
...
/usr/lib/libcurses.a /usr/ccs/lib/libxcurses.a
/usr/ccs/lib/libcurses.a /usr/ccs/lib/libxcurses.a
EOD

# @(#)27        1.2  src/packages/bos/rte/mp/usr/bos.rte.mp.pre_d.sh, pkgbos, pkg411, GOLD410 3/31/94 10:51:15
#
#   COMPONENT_NAME: pkgbos
#
#   FUNCTIONS: bos.rte.mp.pre_d
#
#   ORIGINS: 27
#
#
...
# This option can only be deinstalled if this is a UP system.

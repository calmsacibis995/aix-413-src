#!/usr/bin/ksh
# SCCS_ID = "@(#)37	1.1  src/packages/bos/rte/loc/usr/bos.rte.loc.pre_u.sh, pkgbossub, pkg41J, 9521B_all  5/25/95  08:10:10"
#---------------------------------------------------------------------
# ORIGINS: 27
#
...
#  have been fixed
#-------------------------------------------------------------
needsFix=$(${ODMGET} -q "file_type=0 and loc0=/usr/lib/libi18n.a" inventory 2>/dev/null)

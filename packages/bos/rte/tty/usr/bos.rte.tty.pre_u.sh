#!/usr/bin/ksh
# SCCS_ID = "@(#)42	1.1  src/packages/bos/rte/tty/usr/bos.rte.tty.pre_u.sh, pkgbossub, pkg41J, 9521B_all  5/25/95  08:10:18"
#---------------------------------------------------------------------
# ORIGINS: 27
#
...
#  have been fixed
#-------------------------------------------------------------
needsFix=$(${ODMGET} -q "file_type=0 and loc0=/usr/lib/uucp/Devices" inventory 2>/dev/null)

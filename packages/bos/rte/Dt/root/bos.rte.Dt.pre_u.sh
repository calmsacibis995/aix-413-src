#!/usr/bin/ksh
# SCCS_ID = "@(#)22	1.1  src/packages/bos/rte/Dt/root/bos.rte.Dt.pre_u.sh, pkgbossub, pkg41J, 9521B_all  5/25/95  08:06:59"
#---------------------------------------------------------------------
# ORIGINS: 27
#
...
#  have been fixed
#-------------------------------------------------------------
needsFix=$(${ODMGET} -q "file_type=0 and loc0=/etc/dtappintegrate" inventory 2>/dev/null)
...
/etc/dtappintegrate /usr/sbin/dtappintegrate
EOD

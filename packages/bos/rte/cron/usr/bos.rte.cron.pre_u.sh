#!/usr/bin/ksh
# SCCS_ID = "@(#)29	1.1  src/packages/bos/rte/cron/usr/bos.rte.cron.pre_u.sh, pkgbossub, pkg41J, 9521B_all  5/25/95  08:09:56"
#---------------------------------------------------------------------
# ORIGINS: 27
#
...
#  have been fixed
#-------------------------------------------------------------
needsFix=$(${ODMGET} -q "file_type=0 and loc0=/usr/lib/cron" inventory 2>/dev/null)

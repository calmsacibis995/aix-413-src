#!/usr/bin/ksh
# SCCS_ID = "@(#)30	1.1  src/packages/bos/rte/edit/usr/bos.rte.edit.pre_u.sh, pkgbossub, pkg41J, 9521B_all  5/25/95  08:09:57"
#---------------------------------------------------------------------
# ORIGINS: 27
#
...
#  have been fixed
#-------------------------------------------------------------
needsFix=$(${ODMGET} -q "file_type=0 and loc0=/usr/lib/expreserve" inventory 2>/dev/null)
...
/usr/lib/exrecover /usr/lbin/exrecover
/usr/lib/expreserve /usr/lbin/expreserve
EOD

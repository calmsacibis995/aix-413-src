#!/usr/bin/ksh
# SCCS_ID = "@(#)27	1.1  src/packages/bos/rte/bind_cmds/usr/bos.rte.bind_cmds.pre_u.sh, pkgbossub, pkg41J, 9521B_all  5/25/95  08:09:53"
#---------------------------------------------------------------------
# ORIGINS: 27
#
...
#  have been fixed
#-------------------------------------------------------------
needsFix=$(${ODMGET} -q "file_type=0 and loc0=/usr/bin/ar" inventory 2>/dev/null)
...
/usr/usg/nm /usr/ccs/bin/nm
/usr/ucb/what /usr/bin/what
/usr/lib/bind /usr/ccs/bin/bind
/usr/bin/strip /usr/ccs/bin/strip
/usr/bin/strings /usr/ccs/bin/strings
/usr/bin/ranlib /usr/ccs/bin/ranlib
/usr/bin/nm /usr/ccs/bin/nm
/usr/bin/lorder /usr/ccs/bin/lorder
/usr/bin/ld /usr/ccs/bin/ld
/usr/bin/dump /usr/sbin/dump
/usr/bin/ar /usr/ccs/bin/ar
EOD

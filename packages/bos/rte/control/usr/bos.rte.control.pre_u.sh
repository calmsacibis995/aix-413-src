#!/usr/bin/ksh
# SCCS_ID = "@(#)28	1.1  src/packages/bos/rte/control/usr/bos.rte.control.pre_u.sh, pkgbossub, pkg41J, 9521B_all  5/25/95  08:09:54"
#---------------------------------------------------------------------
# ORIGINS: 27
#
...
#  have been fixed
#-------------------------------------------------------------
needsFix=$(${ODMGET} -q "file_type=0 and loc0=/usr/bin/renice" inventory 2>/dev/null)
...
/usr/bin/renice /usr/sbin/renice
EOD

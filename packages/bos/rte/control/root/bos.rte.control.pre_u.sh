#!/usr/bin/ksh
# SCCS_ID = "@(#)23	1.1  src/packages/bos/rte/control/root/bos.rte.control.pre_u.sh, pkgbossub, pkg41J, 9521B_all  5/25/95  08:09:10"
#---------------------------------------------------------------------
# ORIGINS: 27
#
...
#  have been fixed
#-------------------------------------------------------------
needsFix=$(${ODMGET} -q "file_type=0 and loc0=/etc/init" inventory 2>/dev/null)

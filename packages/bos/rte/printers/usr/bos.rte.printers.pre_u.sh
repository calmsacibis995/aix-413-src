#!/usr/bin/ksh
# SCCS_ID = "@(#)39	1.1  src/packages/bos/rte/printers/usr/bos.rte.printers.pre_u.sh, pkgbossub, pkg41J, 9521B_all  5/25/95  08:10:13"
#---------------------------------------------------------------------
# ORIGINS: 27
#
...
#  have been fixed
#-------------------------------------------------------------
needsFix=$(${ODMGET} -q "file_type=0 and loc0=/usr/lib/lpd/lpd" inventory 2>/dev/null)

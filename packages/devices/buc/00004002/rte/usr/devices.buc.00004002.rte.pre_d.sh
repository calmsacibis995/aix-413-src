#! /bin/ksh
# @(#)51        1.2 4/20/94 src/packages/devices/buc/00004002/rte/usr/devices.buc.00004002.rte.pre_d.sh, pkgdevgraphics, pkg411, GOLD410 10:33:27
#

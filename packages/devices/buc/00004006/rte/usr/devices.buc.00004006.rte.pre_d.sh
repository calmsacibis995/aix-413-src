#! /bin/ksh
# @(#)53        1.2 4/20/94 src/packages/devices/buc/00004006/rte/usr/devices.buc.00004006.rte.pre_d.sh, pkgdevgraphics, pkg411, GOLD410 10:37:18
#

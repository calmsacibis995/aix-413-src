#! /bin/ksh
# @(#)52        1.2 4/20/94 src/packages/devices/buc/00004005/rte/usr/devices.buc.00004005.rte.pre_d.sh, pkgdevgraphics, pkg411, GOLD410 10:36:06
#

#! /bin/ksh
# @(#)50        1.2 4/20/94 src/packages/devices/buc/00004001/rte/usr/devices.buc.00004001.rte.pre_d.sh, pkgdevgraphics, pkg411, GOLD410 10:19:24
#

#! /bin/ksh
# @(#)29	1.4  src/packages/devices/sio/fda/rte/usr/devices.sio.fda.rte.pre_d.sh, pkgdevbase, pkg411, GOLD410 6/28/94 07:57:22
#
...
#
uniquetypes="adapter/sio/fda adapter/sio/fda_2 adapter/sio/fda_iod"

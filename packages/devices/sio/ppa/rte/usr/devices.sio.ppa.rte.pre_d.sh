#! /bin/ksh
# @(#)40	1.3  src/packages/devices/sio/ppa/rte/usr/devices.sio.ppa.rte.pre_d.sh, pkgdevbase, pkg411, GOLD410 5/4/94 11:28:38
#
...
#
uniquetypes="adapter/sio/ppa adapter/sio/ppa_iod"

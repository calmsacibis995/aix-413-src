#! /bin/ksh
# @(#)61        1.1  src/packages/devices/isa_sio/sa/rte/usr/devices.isa_sio.sa.rte.pre_d.sh, pkgrspc, pkg411, GOLD410 6/28/94 07:41:41
#
...
#
uniquetypes="adapter/isa_sio/s1a adapter/isa_sio/s2a"

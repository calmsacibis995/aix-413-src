#! /bin/ksh
# @(#)47	1.2  src/packages/devices/isa_sio/km/rte/usr/devices.isa_sio.km.rte.pre_d.sh, pkgrspc, pkg41J, 9509A_all 2/15/95 15:09:37
#
...
#
uniquetypes="adapter/isa_sio/isa_mouse adapter/isa_sio/isa_keyboard"

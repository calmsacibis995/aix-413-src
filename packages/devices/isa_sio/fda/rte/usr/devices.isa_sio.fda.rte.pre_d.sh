#! /bin/ksh
# @(#)48        1.1  src/packages/devices/isa_sio/fda/rte/usr/devices.isa_sio.fda.rte.pre_d.sh, pkgrspc, pkg411, GOLD410 6/28/94 07:35:34
#
...
#
uniquetypes="adapter/isa_sio/fda"

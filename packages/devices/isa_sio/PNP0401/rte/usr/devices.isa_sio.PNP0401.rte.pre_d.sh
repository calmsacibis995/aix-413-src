#! /bin/ksh
# @(#)52        1.1  src/packages/devices/isa_sio/PNP0401/rte/usr/devices.isa_sio.PNP0401.rte.pre_d.sh, pkgrspc, pkg41J, 9517A_all 4/25/95 16:09:32
#
...
#
uniquetypes="adapter/isa_sio/ecp"

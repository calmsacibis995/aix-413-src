#! /bin/ksh
# @(#)53        1.1  src/packages/devices/isa_sio/IBM001C/rte/usr/devices.isa_sio.IBM001C.rte.pre_d.sh, pkgrspc, pkg41J, 9517A_all 4/25/95 16:10:09
#
...
#
uniquetypes="adapter/isa_sio/epp"

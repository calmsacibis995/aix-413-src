#! /bin/ksh
# @(#)09        1.1  src/packages/devices/isa/ethernet/rte/usr/devices.isa.ethernet.rte.pre_d.sh, pkgrspc, pkg411, GOLD410 6/10/94 17:19:11
#
...
#
uniquetypes="adapter/isa/ethernet"

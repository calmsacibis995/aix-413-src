#! /bin/ksh
# @(#)32        1.1  src/packages/devices/isa/sio/rte/usr/devices.isa.sio.rte.pre_d.sh, pkgrspc, pkg411, GOLD410 6/28/94 07:27:15
#
#   COMPONENT_NAME: rspcpkg
#

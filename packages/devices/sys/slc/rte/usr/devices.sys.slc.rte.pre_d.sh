#! /bin/ksh
# @(#)52        1.3  src/packages/devices/sys/slc/rte/usr/devices.sys.slc.rte.pre_d.sh, pkgdevcommo, pkg411, GOLD410 2/8/94 09:50:00
#
...
#
uniquetypes="adapter/sys/slc adapter/slc/otp adapter/otp/op node/node/ops"

#! /bin/ksh
# @(#)13	1.5  src/packages/devices/base/rte/usr/devices.base.rte.pre_d.sh, pkgdevbase, pkg411, GOLD410 4/1/94 15:00:53
#
...
#
uniquetypes="sys/node/sys sys/node/sys1 planar/sys/sysplanar1 planar/sys/sysplanar2 planar/sys/sysplanar3"

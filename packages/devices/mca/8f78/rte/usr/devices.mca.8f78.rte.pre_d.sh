#! /bin/ksh
# @(#)18	1.3  src/packages/devices/mca/8f78/rte/usr/devices.mca.8f78.rte.pre_d.sh, pkgdevbase, pkg411, GOLD410 2/21/94 16:28:23
#
...
#
uniquetypes="adapter/mca/serdasda adapter/serdasda/serdasdc disk/serdasdc/serdasdd disk/serdasdc/serdasdd2 disk/serdasdc/serdasdd4 disk/serdasdc/2000mb"

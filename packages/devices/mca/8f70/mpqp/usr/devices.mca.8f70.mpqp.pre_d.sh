#! /bin/ksh
# @(#)01	1.1  src/packages/devices/mca/8f70/mpqp/usr/devices.mca.8f70.mpqp.pre_d.sh, pkgdevcommo, pkg411, GOLD410 3/28/94 14:56:36
#
...
#
uniquetypes="driver/portmaster/mpqp port/mpqp/mpqport"

#! /bin/ksh
# @(#)89	1.1  src/packages/devices/mca/8f70/rte/usr/devices.mca.8f70.rte.pre_d.sh, pkgdevcommo, pkg411, GOLD410 3/29/94 14:32:13
#
...
#
uniquetypes="adapter/mca/portmaster"

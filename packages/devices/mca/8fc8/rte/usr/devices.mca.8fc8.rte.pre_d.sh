#! /bin/ksh
# @(#)60        1.3  src/packages/devices/mca/8fc8/rte/usr/devices.mca.8fc8.rte.pre_d.sh, pkgdevcommo, pkg411, GOLD410 2/8/94 09:49:13
#
...
#
uniquetypes="adapter/mca/tokenring"

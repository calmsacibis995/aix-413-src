#! /bin/ksh
# @(#)63        1.2 4/20/94 src/packages/devices/mca/8ee5/rte/usr/devices.mca.8ee5.rte.pre_d.sh, pkgdevgraphics, pkg411, GOLD410 11:03:34
#
...
#
uniquetypes="adapter/mca/graygda"

#! /bin/ksh
# @(#)67        1.2 4/20/94 src/packages/devices/mca/edd5/com/usr/devices.mca.edd5.com.pre_d.sh, pkgdevgraphics, pkg411, GOLD410 11:09:22
#
...
#
uniquetypes="adapter/mca/gsla dial/gio/dials lpfk/gio/lpfkeys"

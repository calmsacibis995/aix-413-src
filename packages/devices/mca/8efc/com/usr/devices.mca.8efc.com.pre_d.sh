#! /bin/ksh
# @(#)17	1.3  src/packages/devices/mca/8efc/com/usr/devices.mca.8efc.com.pre_d.sh, pkgdevbase, pkg411, GOLD410 2/21/94 16:28:20
#
...
#
uniquetypes="driver/scsi_scb/vscsi"

#! /bin/ksh
# @(#)16	1.3  src/packages/devices/mca/8efc/rte/usr/devices.mca.8efc.rte.pre_d.sh, pkgdevbase, pkg411, GOLD410 2/21/94 16:28:17
#
...
#
uniquetypes="adapter/mca/8efc adapter/sio/8efc"

#! /bin/ksh
# @(#)14	1.3  src/packages/devices/mca/8d77/rte/usr/devices.mca.8d77.rte.pre_d.sh, pkgdevbase, pkg411, GOLD410 2/21/94 16:28:09
#
...
#
uniquetypes="adapter/mca/hscsi adapter/sio/hscsi"

#! /bin/ksh
# @(#)90	1.1  src/packages/devices/scsi/tm/rte/usr/devices.scsi.tm.rte.pre_d.sh, pkgdevbase, pkg411, GOLD410 4/11/94 13:18:59
#
...
#
uniquetypes="tmscsi/scsi/hscsi tmscsi/scsi/tmscsi tmscsi/scsi/vscsi"

#! /bin/ksh
# @(#)09	1.2  src/packages/devices/pci/3353c388/rte/usr/devices.pci.3353c388.rte.pre_d.sh, pkgrspc, pkg411, 9438A411a 9/19/94 12:24:50
#
...
#
uniquetypes="adapter/pci/3353c388"

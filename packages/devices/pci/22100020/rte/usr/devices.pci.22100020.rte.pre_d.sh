#! /bin/ksh
# @(#)76	1.1  src/packages/devices/pci/22100020/rte/usr/devices.pci.22100020.rte.pre_d.sh, pkgrspc, pkg41J, 9507B 1/30/95 14:01:49
#
...
#
uniquetypes="adapter/pci/22100020"

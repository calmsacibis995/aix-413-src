#! /bin/ksh
# @(#)94	1.2  src/packages/devices/pci/3353c188/rte/usr/devices.pci.3353c188.rte.pre_d.sh, pkgrspc, pkg411, 9438A411a 9/19/94 12:23:15
#
...
#
uniquetypes="adapter/pci/3353c188"

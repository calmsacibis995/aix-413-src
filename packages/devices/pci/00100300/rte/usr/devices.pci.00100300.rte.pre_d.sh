#! /bin/ksh
# @(#)46        1.1  src/packages/devices/pci/00100300/rte/usr/devices.pci.00100300.rte.pre_d.sh, pkgrspc, pkg41J, 9507A 1/25/95 19:07:13
#
...
#
uniquetypes="adapter/pci/ncr825"

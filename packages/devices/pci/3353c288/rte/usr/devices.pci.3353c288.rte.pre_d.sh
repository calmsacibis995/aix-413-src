#! /bin/ksh
# @(#)02	1.2  src/packages/devices/pci/3353c288/rte/usr/devices.pci.3353c288.rte.pre_d.sh, pkgrspc, pkg411, 9438A411a 9/19/94 12:24:01
#
...
#
uniquetypes="adapter/pci/3353c288"

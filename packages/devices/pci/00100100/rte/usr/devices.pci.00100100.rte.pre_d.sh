#! /bin/ksh
# @(#)70        1.2  src/packages/devices/pci/00100100/rte/usr/devices.pci.00100100.rte.pre_d.sh, pkgrspc, pkg41J, 9507A 1/25/95 18:51:23
#
...
#
uniquetypes="adapter/pci/ncr810"

#! /bin/ksh
# @(#)47	1.1  src/packages/devices/pci/14101800/rte/usr/devices.pci.14101800.rte.pre_d.sh, pkgrspc, pkg41J, 9513A_all 3/27/95 09:38:14
#
...
#
uniquetypes="adapter/pci/14101800"

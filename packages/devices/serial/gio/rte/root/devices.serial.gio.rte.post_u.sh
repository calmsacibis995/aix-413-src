#!/bin/ksh
#  @(#)57        1.1  src/packages/devices/serial/gio/rte/root/devices.serial.gio.rte.post_u.sh, pkgdevgraphics, pkg41J, 9518A_all 5/1/95 13:15:33
#
#   COMPONENT_NAME: pkgdevgraphics
#
#   FUNCTIONS: devices.serial.gio.rte (root) post update configuration
#
#   ORIGINS: 27
#
#

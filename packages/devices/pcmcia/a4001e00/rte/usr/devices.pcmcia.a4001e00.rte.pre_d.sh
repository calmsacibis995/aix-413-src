#! /bin/ksh
# @(#)24	1.2  src/packages/devices/pcmcia/a4001e00/rte/usr/devices.pcmcia.a4001e00.rte.pre_d.sh, pkgrspc, pkg411, 9437A411a 9/8/94 12:26:30
#
...
#
uniquetypes="adapter/pcmcia/a4001e00"
